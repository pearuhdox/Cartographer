execute if block ~ ~-0.2 ~ spawner positioned ~ ~-0.2 ~ align xyz positioned ~0.5 ~ ~0.5 run summon armor_stand ~ ~0.5 ~ {Small:1b,Marker:1b,Invisible:1b,Tags:["cartographer_colossus","waiting_greed"]}
...
execute if block ~ ~-0.2 ~ spawner run tellraw @s {"text":"The spawner you were standing on is now a Colossus! (Greed)","color":"aqua","italic":false}
