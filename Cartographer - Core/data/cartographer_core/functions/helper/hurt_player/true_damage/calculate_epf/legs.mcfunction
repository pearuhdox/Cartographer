...
data modify storage ca.core:epf_calc temp_item set from entity @s Inventory[{Slot:101b}]
...
scoreboard players operation @s epf_prot += $temp ca.epf
...
scoreboard players operation @s epf_proj += $temp ca.epf
...
scoreboard players operation @s epf_blas += $temp ca.epf
...
scoreboard players operation @s epf_fire += $temp ca.epf
...
scoreboard players operation @s epf_fall += $temp ca.epf