...
execute store result score $cart_cmd_fdbk global_options run gamerule showDeathMessages
execute if score $cart_cmd_fdbk global_options matches 1 run gamerule showDeathMessages false