kill @e[type=iron_golem,tag=cart_damage_dealer]

summon iron_golem ~ ~1024 ~ {CustomName:'{"text":"Custom Damage"}',NoGravity:1b,DeathLootTable:"no_lol",NoAI:1b,Health:1f,Tags:["cart_damage_dealer"],ArmorItems:[{},{},{},{id:"minecraft:netherite_helmet",Count:1b,tag:{Enchantments:[{id:"minecraft:thorns",lvl:11s},{id:"minecraft:vanishing_curse",lvl:1s}]}}],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],Attributes:[{Name:generic.max_health,Base:1},{Name:generic.movement_speed,Base:0},{Name:generic.attack_damage,Base:0},{Name:generic.armor,Base:0}]}
