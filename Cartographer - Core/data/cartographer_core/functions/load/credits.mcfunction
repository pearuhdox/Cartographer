...
tellraw @p [{"text":"❰","color":"gold"},{"text":" Suso","color":"#55FF17","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"Technical Debt Collector","color":"#FFE0A3","italic":true}]}},{"text":"❱ ","color":"gold"},{"text":"Optimization Assistance and Bugfixing. Player Data Storage System. Infinity 3.0.","color":"#FFE0A3","italic":true},{"text":" [Link]","color":"aqua","italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"Suso's download for Player Data Storage.","color":"#FFE0A3","italic":true}]},"clickEvent":{"action":"open_url","value":"https://github.com/5uso/Player-Data-Storage"}}]
...
tellraw @p [{"text":"❰","color":"gold"},{"text":" GalacticAC ","color":"#BCFF70","bold":false,"italic":false},{"text":"❱ ","color":"gold"},{"text":"Original invention of the custom player damage implementation.","color":"#FFE0A3","italic":true}]
tellraw @p [{"text":"❰","color":"gold"},{"text":" Gizmo90704 ","color":"#08A4FF","bold":false,"italic":false},{"text":"❱ ","color":"gold"},{"text":"Inspiration and ideas for Custom Enchantments and Mob Abilities. Beta testing.","color":"#FFE0A3","italic":true}]
