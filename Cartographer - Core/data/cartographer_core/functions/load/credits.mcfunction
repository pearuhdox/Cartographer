...
tellraw @p [{"text":"❰","color":"gold"},{"text":" GalacticAC ","color":"#8FD2FF","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"\"Not funni, didn't laugh.\"","color":"#FFE0A3","italic":true}]}},{"text":"❱ ","color":"gold"},{"text":"Original invention of the custom player damage implementation.","color":"#FFE0A3","italic":true}]
