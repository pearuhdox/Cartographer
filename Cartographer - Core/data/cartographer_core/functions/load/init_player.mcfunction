...
execute unless score @s ehp_listen matches 0.. run scoreboard players add @s ehp_listen 1
execute unless score @s phe_listen matches 0.. run scoreboard players add @s phe_listen 1
execute unless score @s ca.reload_type matches 0.. run scoreboard players set @s ca.reload_type 0
