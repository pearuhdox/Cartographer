...
execute as @e[type=!#cartographer_core:not_tracked,predicate=cartographer_core:in_valid_dimension,type=!#cartographer_core:item_frames,type=!item,type=!player] at @s run function cartographer_core:loop/entity_calls/1_second
