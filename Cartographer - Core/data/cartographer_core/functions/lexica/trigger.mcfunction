...
execute if score @s ca.lexica_trig matches 3542 run function cartographer_mob_abilities:lexica_calls/pages/category/traits/other/legionary
execute if score @s ca.lexica_trig matches 3552 run function cartographer_mob_abilities:lexica_calls/pages/category/traits/other/predator
execute if score @s ca.lexica_trig matches 3562 run function cartographer_mob_abilities:lexica_calls/pages/category/traits/other/volatile
