execute if entity @a[distance=..10,scores={helper_power=8..11}] run attribute @s minecraft:generic.attack_damage base set 1.5
...
execute if entity @a[distance=..10,scores={helper_power=12..15}] run attribute @s minecraft:generic.attack_damage base set 3
...
execute if entity @a[distance=..10,scores={helper_power=16..19}] run attribute @s minecraft:generic.attack_damage base set 4.5
...
execute if entity @a[distance=..10,scores={helper_power=20..}] run attribute @s minecraft:generic.attack_damage base set 6
