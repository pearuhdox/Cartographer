summon iron_golem ~ ~ ~ {Silent:1b,DeathLootTable:"cartographer_mimics:colossus",PersistenceRequired:1b,Health:200f,PlayerCreated:0b,AngerTime:2147483647,Motion:[0.0,0.5,0.0],Tags:["pride_colossus","active_colossus","ca.ability_haste+","ca.ability_dmg--","ca.has_active","ca.smash","ca.acrobatic","ca.acro_gap_close_after","ca.touch","ca.zephyrous"],CustomName:'{"text":"Colossus of Pride","color":"red","bold":true,"italic":false}',ArmorItems:[{},{},{},{id:"minecraft:leather_helmet",Count:1b,tag:{Enchantments:[{id:"minecraft:projectile_protection",lvl:5s},{id:"minecraft:vanishing_curse",lvl:1s}]}}],Attributes:[{Name:generic.max_health,Base:200},{Name:generic.attack_damage,Base:1},{Name:generic.armor,Base:0}]}
