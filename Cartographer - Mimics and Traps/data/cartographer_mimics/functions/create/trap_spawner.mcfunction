...
execute if block ~ ~-0.2 ~ spawner run tellraw @s {"text":"The spawner you were standing on is now a Trap Spawner. It needs other tags supplied to have behavior.","color":"aqua","italic":false}
