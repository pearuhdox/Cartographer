...
execute unless block ~ ~-0.5 ~ #cartographer_core:can_raycast if block ~ ~-1.5 ~ #cartographer_core:can_raycast run summon marker ~ ~-0.5 ~ {Tags:["ca.fall_trap_drop_block","ca.trap_spawner"]}