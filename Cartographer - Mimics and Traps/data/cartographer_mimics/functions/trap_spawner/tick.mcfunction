...
execute if entity @s[tag=ca.trap_spawner,tag=ca.trap_translocating] unless score @s ca.trap_timer matches 1.. if entity @a[distance=..16] run function cartographer_mimics:trap_spawner/translocating/analyze
...
execute if entity @s[tag=ca.trap_translocating] if score @s ca.trap_timer matches 1.. run function cartographer_mimics:trap_spawner/translocating/ticking
