...
execute if score @s ca.wave_time matches 0 unless score @s ca.wave_time = $time ca.wave_time run function cartographer_mimics:trap_spawner/disguise_spawner/start
