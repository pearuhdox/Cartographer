...
execute as @e[type=interaction,tag=ca.cartographer_mimic,distance=..5] at @s run function cartographer_mimics:triggers/mimics/verify_right

advancement revoke @s only cartographer_mimics:mimics/right_click