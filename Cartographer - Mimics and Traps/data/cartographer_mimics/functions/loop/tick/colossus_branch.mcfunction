...
execute store result score $rage_c mimic_health run bossbar get cartographer:colossus max
scoreboard players operation $rage_c mimic_health /= $2 ca.CONSTANT

#execute if entity @s[tag=colossus_wrath] run scoreboard players operation @s mimic_health *= $2 ca.CONSTANT
#execute if entity @s[tag=colossus_greed] run scoreboard players operation @s mimic_health *= $2 ca.CONSTANT
...
execute if entity @s[tag=colossus_pride,tag=!ca.enraged] if score @s mimic_health <= $rage_c mimic_health run function cartographer_mimics:colossus/enrage/pride
execute if entity @s[tag=colossus_wrath,tag=!ca.enraged] if score @s mimic_health <= $rage_c mimic_health run function cartographer_mimics:colossus/enrage/wrath
execute if entity @s[tag=colossus_envy,tag=!ca.enraged] if score @s mimic_health <= $rage_c mimic_health run function cartographer_mimics:colossus/enrage/envy
execute if entity @s[tag=colossus_lust,tag=!ca.enraged] if score @s mimic_health <= $rage_c mimic_health run function cartographer_mimics:colossus/enrage/lust
execute if entity @s[tag=colossus_greed,tag=!ca.enraged] if score @s mimic_health <= $rage_c mimic_health run function cartographer_mimics:colossus/enrage/greed
execute if entity @s[tag=colossus_gluttony,tag=!ca.enraged] if score @s mimic_health <= $rage_c mimic_health run function cartographer_mimics:colossus/enrage/gluttony
execute if entity @s[tag=colossus_sloth,tag=!ca.enraged] if score @s mimic_health <= $rage_c mimic_health run function cartographer_mimics:colossus/enrage/sloth
