...
execute if entity @a[gamemode=!creative,distance=..6,scores={helper_open_trap=1..},nbt=!{active_effects:[{id:"minecraft:invisibility"}]},predicate=!cartographer_mimics:mimic_disguised] run scoreboard players set $mimic_tripped setup 1
