execute if score $target_light_level dies.master matches 0 run data merge entity @s {brightness:{sky:5,block:5}}
...
execute if score $target_light_level dies.master matches 15 run data merge entity @s {brightness:{sky:10,block:10}}
