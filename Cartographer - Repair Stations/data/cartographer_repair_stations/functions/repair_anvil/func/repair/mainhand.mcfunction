...
execute if data entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] SelectedItem.tag.Damage store result score $item_damage ca.repair_anvil_master run data get entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] SelectedItem.tag.Damage
execute if data entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] SelectedItem.tag.Damage store result score $repair_cost ca.repair_anvil_master run data get entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] SelectedItem.tag.RepairCost
execute if data entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] SelectedItem.tag.Damage store result score $lapis_cost ca.repair_anvil_master run data get entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] SelectedItem.tag.LapisCost
