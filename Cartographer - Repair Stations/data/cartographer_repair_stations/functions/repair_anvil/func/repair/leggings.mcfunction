...
execute if data entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] Inventory[{Slot:101b}].tag.Damage store result score $repair_cost ca.repair_anvil_master run data get entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] Inventory[{Slot:101b}].tag.RepairCost
execute if data entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] Inventory[{Slot:101b}].tag.Damage store result score $lapis_cost ca.repair_anvil_master run data get entity @p[advancements={cartographer_repair_stations:repair_anvil/right_click=true}] Inventory[{Slot:101b}].tag.LapisCost
