...
data modify storage cartographer_repair_stations:crystal_shield data set from entity @s Inventory[{Slot:101b}]
...
loot replace entity @s armor.legs 1 mine 4206900 0 4206900 air{drop_contents:1b}
