...
tp @e[type=sheep,tag=repair_interact_return,limit=2,distance=..2.7] ~ -65 ~
tp @e[type=sheep,tag=repair_interact_confirm,limit=2,distance=..2.7] ~ -65 ~
tp @e[type=armor_stand,tag=repair_indicator_return,limit=3,distance=..2.7] ~ -65 ~
tp @e[type=armor_stand,tag=repair_indicator_confirm,limit=3,distance=..2.7] ~ -65 ~
