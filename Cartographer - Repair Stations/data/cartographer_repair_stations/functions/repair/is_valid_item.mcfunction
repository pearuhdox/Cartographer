...
execute if entity @s[nbt={Item:{id:"minecraft:wooden_pickaxe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:wooden_hoe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item

execute if entity @s[nbt={Item:{id:"minecraft:stone_sword"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:stone_axe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:stone_shovel"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:stone_pickaxe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:stone_hoe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item

execute if entity @s[nbt={Item:{id:"minecraft:golden_sword"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:golden_axe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:golden_shovel"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:golden_pickaxe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:golden_hoe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item

execute if entity @s[nbt={Item:{id:"minecraft:iron_sword"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:iron_axe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:iron_shovel"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:iron_pickaxe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:iron_hoe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item

execute if entity @s[nbt={Item:{id:"minecraft:diamond_sword"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:diamond_axe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:diamond_shovel"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:diamond_pickaxe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:diamond_hoe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item

execute if entity @s[nbt={Item:{id:"minecraft:netherite_sword"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:netherite_axe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:netherite_shovel"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:netherite_pickaxe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:netherite_hoe"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item

execute if entity @s[nbt={Item:{id:"minecraft:bow"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:crossbow"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:trident"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item

execute if entity @s[nbt={Item:{id:"minecraft:shield"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:fishing_rod"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:carrot_on_a_stick"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:warped_fungus_on_a_stick"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:shears"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:flint_and_steel"}}] run data modify entity 31182015-1851-6191-0000-914162120 HandItems[0] set from entity @s Item

execute if entity @s[nbt={Item:{id:"minecraft:leather_helmet"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[3] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:golden_helmet"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[3] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:chainmail_helmet"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[3] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:iron_helmet"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[3] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:diamond_helmet"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[3] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:netherite_helmet"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[3] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:turtle_helmet"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[3] set from entity @s Item

execute if entity @s[nbt={Item:{id:"minecraft:leather_chestplate"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[2] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:golden_chestplate"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[2] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:chainmail_chestplate"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[2] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:iron_chestplate"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[2] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:diamond_chestplate"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[2] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:netherite_chestplate"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[2] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:elytra"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[2] set from entity @s Item

execute if entity @s[nbt={Item:{id:"minecraft:leather_leggings"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[1] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:golden_leggings"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[1] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:chainmail_leggings"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[1] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:iron_leggings"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[1] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:diamond_leggings"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[1] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:netherite_leggings"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[1] set from entity @s Item

execute if entity @s[nbt={Item:{id:"minecraft:leather_boots"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:golden_boots"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:chainmail_boots"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:iron_boots"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:diamond_boots"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[0] set from entity @s Item
execute if entity @s[nbt={Item:{id:"minecraft:netherite_boots"}}] run data modify entity 31182015-1851-6191-0000-914162120 ArmorItems[0] set from entity @s Item
...
execute as @s[tag=chest] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add chest
execute as @s[tag=legs] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add legs
execute as @s[tag=feet] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add feet

execute as @s[tag=wood] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add wood
execute as @s[tag=stone] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add stone
execute as @s[tag=leather] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add leather
execute as @s[tag=string] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add string
execute as @s[tag=quartz] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add quartz
execute as @s[tag=chain] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add chain
execute as @s[tag=scute] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add scute
execute as @s[tag=carrot] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add carrot
execute as @s[tag=fungus] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add fungus
execute as @s[tag=iron] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add iron
execute as @s[tag=gold] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add gold
execute as @s[tag=diamond] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add diamond
execute as @s[tag=netherite] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add netherite
execute as @s[tag=membrane] at @s if entity @a[distance=..7] as 31182015-1851-6191-0000-914162120 at @s run tag @s add membrane

execute if entity @s[tag=valid] run kill @s

execute unless entity @s[tag=valid] run kill 31182015-1851-6191-0000-914162120
...
kill 31182015-1851-6191-0000-1291453
kill 31182015-1851-6191-0000-1291454