...
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:wooden_shovel"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:wooden_pickaxe"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:wooden_hoe"}}] run tag @s add held

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:stone_sword"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:stone_axe"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:stone_shovel"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:stone_pickaxe"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:stone_hoe"}}] run tag @s add held

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_sword"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_axe"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_shovel"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_pickaxe"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_hoe"}}] run tag @s add held

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_sword"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_axe"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_shovel"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_pickaxe"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_hoe"}}] run tag @s add held

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_sword"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_axe"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_shovel"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_pickaxe"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_hoe"}}] run tag @s add held

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_sword"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_axe"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_shovel"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_pickaxe"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_hoe"}}] run tag @s add held

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:bow"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:crossbow"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:trident"}}] run tag @s add held

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:shield"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:fishing_rod"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:carrot_on_a_stick"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:warped_fungus_on_a_stick"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:shears"}}] run tag @s add held
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:flint_and_steel"}}] run tag @s add held

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:leather_helmet"}}] run tag @s add helm
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_helmet"}}] run tag @s add helm
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:chainmail_helmet"}}] run tag @s add helm
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_helmet"}}] run tag @s add helm
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_helmet"}}] run tag @s add helm
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_helmet"}}] run tag @s add helm
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:turtle_helmet"}}] run tag @s add helm

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:leather_chestplate"}}] run tag @s add chest
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_chestplate"}}] run tag @s add chest
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:chainmail_chestplate"}}] run tag @s add chest
...
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:chainmail_leggings"}}] run tag @s add legs
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_leggings"}}] run tag @s add legs
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_leggings"}}] run tag @s add legs
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_leggings"}}] run tag @s add legs

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:leather_boots"}}] run tag @s add feet
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_boots"}}] run tag @s add feet
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:chainmail_boots"}}] run tag @s add feet
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_boots"}}] run tag @s add feet
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_boots"}}] run tag @s add feet
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_boots"}}] run tag @s add feet

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:wooden_sword"}}] run tag @s add wood
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:wooden_axe"}}] run tag @s add wood
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:wooden_shovel"}}] run tag @s add wood
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:wooden_pickaxe"}}] run tag @s add wood
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:wooden_hoe"}}] run tag @s add wood

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:stone_sword"}}] run tag @s add stone
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:stone_axe"}}] run tag @s add stone
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:stone_shovel"}}] run tag @s add stone
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:stone_pickaxe"}}] run tag @s add stone
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:stone_hoe"}}] run tag @s add stone

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_sword"}}] run tag @s add gold
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_axe"}}] run tag @s add gold
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_shovel"}}] run tag @s add gold
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_pickaxe"}}] run tag @s add gold
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_hoe"}}] run tag @s add gold

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_sword"}}] run tag @s add iron
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_axe"}}] run tag @s add iron
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_shovel"}}] run tag @s add iron
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_pickaxe"}}] run tag @s add iron
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_hoe"}}] run tag @s add iron

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_sword"}}] run tag @s add diamond
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_axe"}}] run tag @s add diamond
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_shovel"}}] run tag @s add diamond
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_pickaxe"}}] run tag @s add diamond
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_hoe"}}] run tag @s add diamond

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_sword"}}] run tag @s add netherite
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_axe"}}] run tag @s add netherite
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_shovel"}}] run tag @s add netherite
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_pickaxe"}}] run tag @s add netherite
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_hoe"}}] run tag @s add netherite

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:bow"}}] run tag @s add string
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:crossbow"}}] run tag @s add string
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:trident"}}] run tag @s add quartz

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:shield"}}] run tag @s add iron
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:fishing_rod"}}] run tag @s add string
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:carrot_on_a_stick"}}] run tag @s add carrot
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:warped_fungus_on_a_stick"}}] run tag @s add fungus
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:shears"}}] run tag @s add iron
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:flint_and_steel"}}] run tag @s add iron

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:leather_helmet"}}] run tag @s add leather
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_helmet"}}] run tag @s add gold
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:chainmail_helmet"}}] run tag @s add chain
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_helmet"}}] run tag @s add iron
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_helmet"}}] run tag @s add diamond
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_helmet"}}] run tag @s add netherite
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:turtle_helmet"}}] run tag @s add scute

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:leather_chestplate"}}] run tag @s add leather
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_chestplate"}}] run tag @s add gold
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:chainmail_chestplate"}}] run tag @s add chain
...
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:chainmail_leggings"}}] run tag @s add chain
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_leggings"}}] run tag @s add iron
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_leggings"}}] run tag @s add diamond
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_leggings"}}] run tag @s add netherite

execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:leather_boots"}}] run tag @s add leather
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:golden_boots"}}] run tag @s add gold
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:chainmail_boots"}}] run tag @s add chain
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:iron_boots"}}] run tag @s add iron
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:diamond_boots"}}] run tag @s add diamond
execute if entity @s[tag=valid] run execute if entity @s[nbt={Item:{id:"minecraft:netherite_boots"}}] run tag @s add netherite

execute as @s[tag=held] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add held
execute as @s[tag=helm] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add helm
execute as @s[tag=chest] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add chest
execute as @s[tag=legs] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add legs
execute as @s[tag=feet] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add feet

execute as @s[tag=wood] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add wood
execute as @s[tag=stone] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add stone
execute as @s[tag=leather] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add leather
execute as @s[tag=string] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add string
execute as @s[tag=quartz] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add quartz
execute as @s[tag=chain] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add chain
execute as @s[tag=scute] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add scute
execute as @s[tag=carrot] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add carrot
execute as @s[tag=fungus] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add fungus
execute as @s[tag=iron] at @s run execute if entity @a[distance=..7] run execute as @e[tag=repair_display] at @s run tag @s add iron
