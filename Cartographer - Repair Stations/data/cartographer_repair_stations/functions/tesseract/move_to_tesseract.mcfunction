execute if data storage cartographer_repair_stations:tesseract Data.Equipped[0].id unless data storage cartographer_repair_stations:tesseract Data.Equipped[0].tag.NoTesseract unless data entity @s SelectedItem.id run scoreboard players set $void_main tesseract 1
execute if data storage cartographer_repair_stations:tesseract Data.Equipped[1].id unless data storage cartographer_repair_stations:tesseract Data.Equipped[1].tag.NoTesseract unless data entity @s Inventory[{Slot:-106b}].id run scoreboard players set $void_off tesseract 1
execute if data storage cartographer_repair_stations:tesseract Data.Equipped[2].id unless data storage cartographer_repair_stations:tesseract Data.Equipped[2].tag.NoTesseract unless data entity @s Inventory[{Slot:100b}].id run scoreboard players set $void_head tesseract 1
execute if data storage cartographer_repair_stations:tesseract Data.Equipped[3].id unless data storage cartographer_repair_stations:tesseract Data.Equipped[3].tag.NoTesseract unless data entity @s Inventory[{Slot:101b}].id run scoreboard players set $void_body tesseract 1
execute if data storage cartographer_repair_stations:tesseract Data.Equipped[4].id unless data storage cartographer_repair_stations:tesseract Data.Equipped[4].tag.NoTesseract unless data entity @s Inventory[{Slot:102b}].id run scoreboard players set $void_legs tesseract 1
execute if data storage cartographer_repair_stations:tesseract Data.Equipped[5].id unless data storage cartographer_repair_stations:tesseract Data.Equipped[5].tag.NoTesseract unless data entity @s Inventory[{Slot:103b}].id run scoreboard players set $void_feet tesseract 1
