...
execute if entity @s[tag=ca.acrobatic_strafe_back,tag=!ca.has_strafed,scores={cooldown=0}] if entity @a[gamemode=!spectator,gamemode=!creative,distance=..16] run function cartographer_mob_abilities:ability_traits/acrobatic/run_effects/strafe_back
...
scoreboard players set @s ca.acrobatic_cooldown 1