...
execute unless entity @a[distance=..10] run scoreboard players set @s co_send -6
execute if entity @a[distance=..10] unless entity @a[distance=..8] run scoreboard players set @s co_send -8
execute if entity @a[distance=..8] unless entity @a[distance=..6] run scoreboard players set @s co_send -10
execute if entity @a[distance=..6] unless entity @a[distance=..4] run scoreboard players set @s co_send -12
execute if entity @a[distance=..4] run scoreboard players set @s co_send -16
