...
execute if entity @s[tag=ca.zephyrous] as @a[tag=ability_tagged] at @s run tag @s add ca.primed_zephyrous
execute if entity @s[tag=ca.zephyrous] run schedule function cartographer_mob_abilities:ability_traits/zephyrous/scheduled 1t

execute unless entity @s[tag=ca.zephyrous] if entity @s[tag=ca.knockback] at @s run function cartographer_mob_abilities:ability_traits/knockback/mob_effect
execute unless entity @s[tag=ca.zephyrous] if entity @s[tag=ca.knockback] as @a[tag=ability_tagged] at @s run tag @s add ca.primed_knockback
execute unless entity @s[tag=ca.zephyrous] if entity @s[tag=ca.knockback] as @a[tag=ability_tagged] at @s run schedule function cartographer_mob_abilities:ability_traits/knockback/scheduled 1t
...
tag @s remove ca.running_touch_creeper
