...
execute if score $overloading_y ca.mob_var matches -6 positioned ~ ~ ~-6 run function cartographer_mob_abilities:ability_traits/overloading/flatten_ground
execute if score $overloading_y ca.mob_var matches -5 positioned ~ ~ ~-5 run function cartographer_mob_abilities:ability_traits/overloading/flatten_ground
execute if score $overloading_y ca.mob_var matches -4 positioned ~ ~ ~-4 run function cartographer_mob_abilities:ability_traits/overloading/flatten_ground
execute if score $overloading_y ca.mob_var matches -3 positioned ~ ~ ~-3 run function cartographer_mob_abilities:ability_traits/overloading/flatten_ground
