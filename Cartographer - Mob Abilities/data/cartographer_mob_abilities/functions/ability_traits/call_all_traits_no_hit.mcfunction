...
execute if entity @s[tag=ca.volatile] unless entity @s[tag=ca.augmenter] unless entity @s[tag=ca.storm] unless entity @s[tag=ca.orbit] unless entity @s[tag=ca.sniper_shot] unless entity @s[tag=ca.volley] unless entity @s[tag=ca.spin_shot] unless entity @s[tag=ca.sidearm] unless entity @s[tag=ca.barrage] at @s run function cartographer_mob_abilities:ability_traits/volatile/effect
