...
execute if entity @s[tag=ca.volatile] unless entity @s[tag=ca.magic_missile] unless entity @s[tag=ca.trapper] unless entity @s[tag=ca.grenadier] unless entity @s[tag=ca.needle] at @s run function cartographer_mob_abilities:ability_traits/volatile/effect