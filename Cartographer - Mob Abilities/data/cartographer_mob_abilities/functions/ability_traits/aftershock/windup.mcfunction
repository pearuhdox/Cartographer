...
execute if score @s ca.aftershock matches 1 run function cartographer_mob_abilities:ability_traits/aftershock/effect

scoreboard players remove @s ca.aftershock 1