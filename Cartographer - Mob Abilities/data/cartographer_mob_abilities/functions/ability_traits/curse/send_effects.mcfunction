...
summon area_effect_cloud ~ ~1 ~ {Tags:["ca.curse_reapply_cloud"],Particle:"block air",ReapplicationDelay:0,Radius:0.1f,RadiusOnUse:-5.0f,Duration:10,DurationOnUse:0f,Age:-1,WaitTime:0,Potion:"minecraft:awkward",Effects:[]}
