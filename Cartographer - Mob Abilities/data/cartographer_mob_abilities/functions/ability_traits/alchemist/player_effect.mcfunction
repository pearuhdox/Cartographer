...
summon area_effect_cloud ~ ~1 ~ {Tags:["ca.alchemist_effect"],Particle:"block air",ReapplicationDelay:0,Radius:0.4f,RadiusOnUse:-5f,Duration:10,DurationOnUse:0,Age:-1,WaitTime:0}
