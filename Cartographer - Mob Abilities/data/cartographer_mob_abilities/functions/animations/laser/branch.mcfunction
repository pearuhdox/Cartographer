...
execute if score @s ability_charge matches 1..2 as @s at @s anchored eyes facing entity @p[gamemode=!spectator,gamemode=!creative] eyes run tp @s ^ ^ ^ ~ ~
execute if score @s ability_charge matches 11..70 as @s at @s anchored eyes facing entity @p[gamemode=!spectator,gamemode=!creative] feet positioned ^ ^ ^1 rotated as @s positioned ^ ^ ^10 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^ ~ ~
execute if score @s ability_charge matches 71..110 as @s at @s anchored eyes facing entity @p[gamemode=!spectator,gamemode=!creative] feet positioned ^ ^ ^1 rotated as @s positioned ^ ^ ^6 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^ ~ ~
execute if score @s ability_charge matches 111.. as @s at @s anchored eyes facing entity @p[gamemode=!spectator,gamemode=!creative] feet positioned ^ ^ ^1 rotated as @s positioned ^ ^ ^3 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^ ~ ~
