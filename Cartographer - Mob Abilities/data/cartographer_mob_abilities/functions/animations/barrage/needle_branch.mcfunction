...
#Calc Damage
execute run function cartographer_mob_abilities:projectiles/behavior/needle/calc_damage
execute run function cartographer_mob_abilities:projectiles/behavior/needle/calc_damage
...
execute unless entity @s[tag=ca.ignore_traits_active] run function cartographer_mob_abilities:projectiles/behavior/needle/trait_copy
execute unless entity @s[tag=ca.ignore_traits_active] run function cartographer_mob_abilities:projectiles/behavior/needle/trait_copy
...
execute as @e[tag=needle_projectile,tag=!aimed] at @s run function cartographer_mob_abilities:projectiles/behavior/needle/aim
execute as @e[tag=needle_projectile,tag=!aimed] at @s run function cartographer_mob_abilities:projectiles/behavior/needle/aim