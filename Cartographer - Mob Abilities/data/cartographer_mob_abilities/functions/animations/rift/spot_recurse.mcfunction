...
execute if score @s ca.raycast matches 1.. if block ~ ~-1 ~ #bb:can_raycast positioned ~ ~-1 ~ run function cartographer_mob_abilities:animations/rift/spot_recurse
...
execute if score @s ca.raycast matches 1.. unless block ~ ~ ~ #bb:can_raycast positioned ~ ~1 ~ run function cartographer_mob_abilities:animations/rift/spot_recurse