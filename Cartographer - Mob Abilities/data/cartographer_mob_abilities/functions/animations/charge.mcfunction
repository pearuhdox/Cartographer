...
execute unless score $gl_ab_ani ca.gamerule matches 1 run function cartographer_mob_abilities:animations/charge/charge_bar
...
execute if score @s ability_charge matches 1 run tp @s ~ ~ ~ facing entity @p[gamemode=!spectator,gamemode=!creative] feet
...
execute unless score @s ability_charge matches 31.. run function cartographer_mob_abilities:loop/tick/animation

execute if score @s ability_charge matches 31.. unless entity @s[tag=has_charged] run function cartographer_mob_abilities:abilities/charge

execute if score @s ability_charge matches 31 run function cartographer_mob_abilities:abilities/charge/reset
