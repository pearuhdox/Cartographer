...
execute if score @s cdl.Death_ID matches 310207 run tellraw @a [{"selector":"@p"},{"text":" was engulfed in soulfire by ","color":"white"},{"selector":"@e[limit=1,tag=soulfire_nova,sort=nearest]"}]
