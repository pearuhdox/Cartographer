...
execute run tp 002f80c0-0001-f879-0000-009c001e7bfc ~ ~ ~ facing entity @p[gamemode=!spectator,gamemode=!creative,nbt=!{active_effects:[{id:"minecraft:invisibility"}]}] feet
...
#debug glowing
#execute if entity @s[tag=can_see_player] unless score $gl_ab_ani ca.gamerule matches 2 unless entity @s[tag=ca.no_glowing] run effect give @s glowing 1 0 true