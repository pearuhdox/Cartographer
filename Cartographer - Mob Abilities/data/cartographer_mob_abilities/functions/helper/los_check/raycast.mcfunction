...
execute if entity @a[distance=..1.2] as 002f80c0-0001-f879-0000-009c001e7bfc at @s run execute as @e[type=#cartographer_core:hostile,tag=has_active,limit=1,sort=nearest,distance=..1] at @s run tag @s add can_see_player
