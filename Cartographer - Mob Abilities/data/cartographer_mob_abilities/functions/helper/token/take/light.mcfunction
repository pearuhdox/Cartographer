...
data modify entity @s ArmorItems[3].tag.HeldToken set from storage cartographer_core:pl_data working_data.Tokens.LightTokens[0]
data remove storage cartographer_core:pl_data working_data.Tokens.LightTokens[0]
