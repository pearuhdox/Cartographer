...
execute if score $type_fresh helper_tokens matches 0 run data modify storage cartographer_core:pl_data working_data.Tokens.LightTokens append from entity @s ArmorItems[3].tag.HeldToken
execute if score $type_fresh helper_tokens matches 1 run data modify storage cartographer_core:pl_data working_data.Tokens.HeavyTokens append from entity @s ArmorItems[3].tag.HeldToken
