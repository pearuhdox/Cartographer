execute store result score $temp ca.ma_epf_blast run data get storage cartographer_mob_abilities:epf_calc head[{id:"minecraft:blast_protection"}].lvl
execute if score $temp ca.ma_epf_blast matches 1.. run scoreboard players operation @s ca.ma_epf_blast += $temp ca.ma_epf_blast

execute store result score $temp ca.ma_epf_fire run data get storage cartographer_mob_abilities:epf_calc head[{id:"minecraft:fire_protection"}].lvl
