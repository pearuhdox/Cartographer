...
execute if score $reduce_proj_speed ca.mob_var matches 1.. if entity @a[distance=..5] run scoreboard players remove @s co_send 8
execute if score $reduce_proj_speed ca.mob_var matches 1.. if entity @a[distance=..5] run scoreboard players add @s co_y 1

execute if score $reduce_proj_speed ca.mob_var matches 1.. unless entity @a[distance=..5] run scoreboard players remove @s co_send 5
execute if score $reduce_proj_speed ca.mob_var matches 1.. unless entity @a[distance=..5] run scoreboard players add @s co_y 1
