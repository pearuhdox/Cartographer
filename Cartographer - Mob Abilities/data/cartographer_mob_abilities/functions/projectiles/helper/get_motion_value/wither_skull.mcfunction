...
execute store result storage cartographer_mob_abilities:projectiles ConversionTemplate[0] double 0.002 run scoreboard players add $con_mp_x ca.xyz_convert 0
execute store result storage cartographer_mob_abilities:projectiles ConversionTemplate[1] double 0.002 run scoreboard players add $con_mp_y ca.xyz_convert 0
execute store result storage cartographer_mob_abilities:projectiles ConversionTemplate[2] double 0.002 run scoreboard players add $con_mp_z ca.xyz_convert 0
