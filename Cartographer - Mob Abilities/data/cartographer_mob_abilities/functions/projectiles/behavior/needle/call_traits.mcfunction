...
execute if entity @s[tag=ca.horrifying] as @a[tag=ability_tagged,distance=..2] at @s run function cartographer_mob_abilities:ability_traits/horrifying/player_effect

execute if entity @s[tag=ca.webbing] as @a[tag=ability_tagged,distance=..2] at @s run function cartographer_mob_abilities:ability_traits/webbing/player_effect
execute if entity @s[tag=ca.cursing] as @a[tag=ability_tagged,distance=..2] at @s run function cartographer_mob_abilities:ability_traits/curse/player_effect
...
execute if entity @s[tag=ca.volatile] as @a[tag=ability_tagged,distance=..2] at @s run function cartographer_mob_abilities:ability_traits/volatile/effect