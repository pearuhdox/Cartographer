...
execute if score @s ca.lifetime matches 0.. run execute unless block ~ ~ ~ #bb:can_raycast run particle minecraft:explosion ~ ~ ~ 0 0 0 0 1 force
...
execute if score @s ca.lifetime matches 81.. run particle minecraft:explosion ~ ~ ~ 0 0 0 0 1 force
