...
execute positioned ~-1.5 ~ ~-1.5 if entity @a[dx=3,dy=0.01,dz=3,tag=ability_tagged] positioned ~1.5 ~ ~1.5 run function cartographer_mob_abilities:projectiles/behavior/trap/cloud/detonate
