function cartographer_mob_abilities:projectiles/behavior/rift/hit

tag @s add ca.rift_hit

execute unless score $zeph_check ca.mob_var matches 1.. unless score @s ca.delta.cooldown matches 1.. run scoreboard players set $strength delta.api.launch 8000
