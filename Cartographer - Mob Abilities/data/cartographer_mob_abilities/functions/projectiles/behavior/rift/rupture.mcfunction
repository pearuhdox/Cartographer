...
execute as @a[distance=..2.5] positioned ~-0.75 ~ ~-0.75 if entity @a[dx=1.5,dz=1.5,dy=0] positioned ~0.75 ~ ~0.75 run function cartographer_mob_abilities:projectiles/behavior/rift/hit
