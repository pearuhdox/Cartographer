...
scoreboard players set $mm_cur ca.var 0
...
execute if entity @s[tag=ca.cursing] run scoreboard players set $mm_cur ca.var 1

execute if entity @s[tag=ca.alchemist] unless entity @s[tag=ca.ignore_traits_active] run function cartographer_mob_abilities:projectiles/behavior/magic_missile/alchemist_save

execute unless entity @s[tag=ca.ignore_traits_active] as @e[type=armor_stand,tag=magic_missile_projectile,limit=1,sort=nearest] run function cartographer_mob_abilities:projectiles/behavior/magic_missile/set_traits


function cartographer_mob_abilities:projectiles/behavior/magic_missile/calc_damage

execute as @e[tag=magic_missile_projectile,sort=nearest,tag=!checked,limit=1] at @s run function cartographer_mob_abilities:projectiles/behavior/magic_missile/apply_stats
