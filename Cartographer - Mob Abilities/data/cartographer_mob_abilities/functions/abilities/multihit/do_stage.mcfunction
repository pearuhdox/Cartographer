...
particle minecraft:sweep_attack ^ ^0.5 ^0.25 0 0 0 1 1 force
particle minecraft:sweep_attack ^ ^0.5 ^0.5 0 0 0 1 1 force
particle minecraft:sweep_attack ^ ^0.5 ^0.75 0 0 0 1 1 force
particle minecraft:sweep_attack ^ ^0.5 ^1.0 0 0 0 1 1 force
particle minecraft:sweep_attack ^ ^0.5 ^1.25 0 0 0 1 1 force

particle minecraft:cloud ^ ^0.25 ^1.5 0.3 0 0.3 0 15 normal
...
execute positioned ^ ^0.5 ^2 positioned ~-0.75 ~ ~-0.75 positioned as @a[tag=!multihit_tagged,dx=0.5,dy=0,dz=0.5] at @s run function cartographer_mob_abilities:abilities/multihit/hit
