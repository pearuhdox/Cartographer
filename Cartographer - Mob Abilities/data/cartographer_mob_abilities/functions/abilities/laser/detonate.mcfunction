summon creeper ~ ~500 ~ {Silent:1b,Tags:["ca.not_delta_creeper","ca.prevent_effects","ca.new_laser_explosion","laser_explosion"],ActiveEffects:[{Id:14,Duration:3,Amplifier:0,ShowParticles:false}],ExplosionRadius:3b,Fuse:3,ignited:1b,CustomName:'{"text":"thermal disencouragement"}'}
