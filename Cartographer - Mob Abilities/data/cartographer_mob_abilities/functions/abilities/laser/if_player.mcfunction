summon creeper ~ ~500 ~ {Silent:1b,Tags:["ca.new_laser_explosion","laser_explosion","ca.not_delta_creeper","ca.prevent_effects"],ActiveEffects:[{Id:14,Duration:4,Amplifier:0,ShowParticles:false}],ExplosionRadius:3b,Fuse:3,ignited:1b,CustomName:'{"text":"thermal disencouragement"}'}
