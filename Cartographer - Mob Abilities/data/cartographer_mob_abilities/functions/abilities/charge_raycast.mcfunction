...
execute if entity @s[scores={helper_raycast=1..}] if block ~ ~ ~ #cartographer_core:can_raycast if block ^ ^ ^0.5 #cartographer_core:can_raycast positioned ^ ^ ^0.5 run function cartographer_mob_abilities:abilities/charge_raycast