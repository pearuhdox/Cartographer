...
execute as @a[gamemode=!spectator,gamemode=!creative,distance=..8] at @s run scoreboard players set @s cdl.Death_ID 310209
execute as @a[gamemode=!spectator,gamemode=!creative,distance=..8] at @s run function cd:lib/player/damage/normal
execute as @a[gamemode=!spectator,gamemode=!creative,distance=..8] at @s run effect give @s poison 15 0
