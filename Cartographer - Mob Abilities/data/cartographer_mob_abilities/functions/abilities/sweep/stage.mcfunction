...
execute as @s positioned as @a[tag=sweep_tagged,distance=..3] run function cartographer_mob_abilities:helper/damage/ability_melee with storage cartographer:macro.mob_abilities
