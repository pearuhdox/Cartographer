...
execute if entity @s[tag=ca.shoot_grenade] facing entity @s feet as 0000001f-00de-140d-0000-0000000276ef positioned as @s run tp @s ^1.5 ^ ^
execute if entity @s[tag=ca.shoot_trap] facing entity @s feet as 0000001f-00de-140d-0000-0000000276ef positioned as @s run tp @s ^1.5 ^ ^
