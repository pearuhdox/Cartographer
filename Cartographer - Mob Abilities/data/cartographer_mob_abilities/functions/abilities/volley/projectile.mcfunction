...
execute if entity @s[tag=ca.sh_grenade] as 0000001f-00de-140d-0000-0000000276ef at @s run tp @s ~ ~4 ~

execute if entity @s[tag=ca.sh_shulker_bullet] as 0000001f-00de-140d-0000-0000000276ef at @s run tp @s ~ ~1 ~
...
execute if entity @s[tag=ca.sh_boomerang] as 0000001f-00de-140d-0000-0000000276ef at @s run tp @s ~ ~0.5 ~
