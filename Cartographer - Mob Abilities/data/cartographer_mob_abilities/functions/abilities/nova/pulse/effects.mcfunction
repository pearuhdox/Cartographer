...
execute as @s positioned as @a[scores={ca.damage_queue=1..},distance=..4.5] run function cartographer_mob_abilities:helper/damage/ability_magic with storage cartographer:macro.mob_abilities
