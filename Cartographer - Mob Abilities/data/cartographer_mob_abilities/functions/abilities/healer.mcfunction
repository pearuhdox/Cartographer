...
execute as @e[distance=0.5..10,tag=!healer,type=#cartographer_core:hostile,sort=nearest,limit=3] at @s run function cartographer_mob_abilities:abilities/healer/effect
