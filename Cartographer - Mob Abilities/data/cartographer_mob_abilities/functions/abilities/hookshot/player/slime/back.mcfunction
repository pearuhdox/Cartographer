execute at @p[scores={ca.hooked=1..},distance=..1.5] facing entity @e[type=#cartographer_core:hostile,scores={ca.hooked=1..},tag=hookshot,limit=1,sort=nearest] feet rotated ~ 0 run tp @s ^ ^ ^-0.4 facing entity @e[type=#cartographer_core:hostile,scores={ca.hooked=1..},tag=hookshot,limit=1,sort=nearest]
