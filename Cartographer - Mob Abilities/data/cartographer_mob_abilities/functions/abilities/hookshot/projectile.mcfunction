...
execute if entity @s[scores={helper_lifetime=7}] as @p[distance=..1.75] at @s run function cartographer_core:helper/hurt_player/by_score
...
execute if entity @s[scores={helper_lifetime=..6}] run tp @s ^ ^ ^2
execute if entity @s[scores={helper_lifetime=21..}] run tp @s ^ ^ ^1
...
execute if entity @s[scores={helper_lifetime=..6}] run playsound minecraft:block.chain.place hostile @a[distance=..12] ~ ~ ~ 1 0.5
execute if entity @s[scores={helper_lifetime=21..}] run playsound minecraft:block.chain.place hostile @a[distance=..12] ~ ~ ~ 1 0.5
