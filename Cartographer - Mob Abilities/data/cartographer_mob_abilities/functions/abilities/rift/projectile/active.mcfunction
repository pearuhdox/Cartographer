execute if score $rift_mod ca.mob_var matches 0 run function cartographer_mob_abilities:abilities/rift/projectile/rupture

playsound minecraft:entity.zombie.break_wooden_door hostile @a[distance=..6] ~ ~ ~ 0.05 1.25

function cartographer_mob_abilities:abilities/rift/projectile/move
function cartographer_mob_abilities:abilities/rift/projectile/ground_fix
