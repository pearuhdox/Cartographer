...
execute unless entity @s[tag=ca.lightning_rod_only] as @a[distance=..16,limit=3,sort=random] at @s positioned ~ ~2 ~ run function cartographer_mob_abilities:abilities/storm/player_effect
