...
execute if entity @s[tag=ca.lightning_rod] unless entity @s[tag=ca.lightning_rod_only] run function cartographer_mob_abilities:abilities/storm/player_effect
execute if entity @s[tag=ca.lightning_rod_only] unless entity @s[tag=ca.lightning_rod] run function cartographer_mob_abilities:abilities/storm/player_effect
