...
scoreboard players operation $orb_damage ca.ability_dmg = @s ca.ability_dmg

scoreboard players operation $orb_damage ca.ability_dmg *= $20 ca.CONSTANT
...
scoreboard players operation $orb_damage ca.ability_dmg /= $10 ca.CONSTANT

scoreboard players operation $damage ca.ability_dmg = $orb_damage ca.ability_dmg
