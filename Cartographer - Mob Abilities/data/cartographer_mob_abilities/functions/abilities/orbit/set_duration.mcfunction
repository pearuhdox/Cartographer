...
execute if score @s ca.orbit_timer > $duration_half ca.orbit_timer as @e[type=#bb:hostile,limit=1,sort=nearest,distance=0.01..12] at @s run function cartographer_mob_abilities:abilities/orbit/apply_duration
