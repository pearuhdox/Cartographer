...
execute if score $mod_overload ca.mob_var matches 4 run function cartographer_mob_abilities:abilities/storm/particle_circle
execute if score $mod_overload_2 ca.mob_var matches 4 run function cartographer_mob_abilities:abilities/storm/line_particle
