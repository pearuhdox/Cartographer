...
execute if entity @s[tag=ca.horrifying] as @a[tag=ability_tagged,distance=..3] at @s run function cartographer_mob_abilities:ability_traits/horrifying/create_tether
