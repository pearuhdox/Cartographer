...
execute as @a[gamemode=!spectator,gamemode=!creative,distance=..3,sort=nearest,limit=1] at @s unless entity @s[tag=no_cdl_msg] run scoreboard players set @s cdl.Death_ID 310203
