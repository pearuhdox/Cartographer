...
execute if score @s ability_charge matches 1 run scoreboard players set @s mob_sturdy 53
...
execute if entity @s[tag=ca.inverse_rift] if score @s ability_charge matches 1 run scoreboard players set @s mob_move_dis 63
execute if entity @s[tag=ca.inverse_rift] if score @s ability_charge matches 1 run scoreboard players set @s mob_sturdy 63
...
execute if score @s ability_charge matches 1 run scoreboard players set $rift_mode ca.var 1
execute if score @s ability_charge matches 1 if entity @s[tag=ca.instant_rift] run scoreboard players set $rift_mode ca.var 2
execute if score @s ability_charge matches 1 if entity @s[tag=ca.inverse_rift] run scoreboard players set $rift_mode ca.var 3

execute if score @s ability_charge matches 1 positioned ~ ~ ~ rotated ~ 0 as @e[tag=rift_marker,sort=nearest,limit=3,distance=..2] run function cartographer_mob_abilities:charge/rift/marker_branch
execute if score @s ability_charge matches 1 as @e[type=area_effect_cloud,distance=..18,tag=rift_spot,tag=!checked] at @s run function cartographer_mob_abilities:charge/rift/spot_recurse_start

scoreboard players set $rift_vfx ability_charge 1
...
execute if score @s ability_charge matches 4 run kill @e[tag=rift_marker]
