...
execute unless entity @s[scores={ability_charge=1..3}] run summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["rift_marker","rift_marker_4","ability_marker"]}
execute unless entity @s[scores={ability_charge=1..3}] run summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["rift_marker","rift_marker_5","ability_marker"]}

execute unless entity @s[scores={ability_charge=1..3}] rotated ~72 0 run tp @e[tag=rift_marker_1,distance=..2,limit=1] ~ ~ ~ ~ ~
execute unless entity @s[scores={ability_charge=1..3}] rotated ~144 0 run tp @e[tag=rift_marker_2,distance=..2,limit=1] ~ ~ ~ ~ ~
execute unless entity @s[scores={ability_charge=1..3}] rotated ~216 0 run tp @e[tag=rift_marker_3,distance=..2,limit=1] ~ ~ ~ ~ ~
execute unless entity @s[scores={ability_charge=1..3}] rotated ~288 0 run tp @e[tag=rift_marker_4,distance=..2,limit=1] ~ ~ ~ ~ ~
execute unless entity @s[scores={ability_charge=1..3}] rotated ~360 0 run tp @e[tag=rift_marker_5,distance=..2,limit=1] ~ ~ ~ ~ ~
...
execute unless entity @s[scores={ability_charge=1..3}] as @e[tag=rift_marker,sort=nearest,limit=5,distance=..2] at @s run function cartographer_mob_abilities:charge/rift/particle_compressed
execute if entity @s[scores={ability_charge=1..2}] as @e[tag=rift_marker,sort=nearest,limit=5,distance=..2] at @s run function cartographer_mob_abilities:charge/rift/particle
