...
execute if entity @s[tag=ca.shoot_arrow] as 0000001f-00de-140d-0000-0000000276ef at @s run tp @s ~ ~1.5 ~
execute if entity @s[tag=ca.shoot_trident] as 0000001f-00de-140d-0000-0000000276ef at @s run tp @s ~ ~1.5 ~
...
execute if entity @s[tag=ca.shoot_grenade] run scoreboard players set $inaccuracy_yaw_min ca.xyz_convert -4
execute if entity @s[tag=ca.shoot_grenade] run scoreboard players set $inaccuracy_yaw_max ca.xyz_convert 4
execute if entity @s[tag=ca.shoot_grenade] run scoreboard players set $inaccuracy_pitch_min ca.xyz_convert -4
execute if entity @s[tag=ca.shoot_grenade] run scoreboard players set $inaccuracy_pitch_max ca.xyz_convert 4

execute unless entity @s[tag=ca.shoot_grenade] run scoreboard players set $reduced_power ca.xyz_convert 2

execute if entity @s[tag=ca.shoot_magic_missile] run scoreboard players set $inaccuracy_yaw_min ca.xyz_convert -4
execute if entity @s[tag=ca.shoot_magic_missile] run scoreboard players set $inaccuracy_yaw_max ca.xyz_convert 4
execute if entity @s[tag=ca.shoot_magic_missile] run scoreboard players set $inaccuracy_pitch_min ca.xyz_convert -4
execute if entity @s[tag=ca.shoot_magic_missile] run scoreboard players set $inaccuracy_pitch_max ca.xyz_convert 4
