...
execute if score @s ability_charge matches 1 run playsound minecraft:item.crossbow.loading_middle hostile @a[distance=..20] ~ ~ ~ 2 0.75
...
execute if score @s ability_charge matches 10 run playsound minecraft:item.crossbow.loading_end hostile @a[distance=..20] ~ ~ ~ 2 0.75
...
execute if score @s ability_charge matches 15.. run function cartographer_mob_abilities:charge/barrage/branch

execute if score @s ability_charge matches 1..45 run effect give @s glowing 1 0 true
...
execute if score @s ability_charge matches 55.. run function cartographer_mob_abilities:abilities/barrage