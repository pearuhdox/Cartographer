...
execute if score @s ca.lifetime matches 0.. run execute if entity @a[dx=0] positioned ~-0.35 ~-0.35 ~-0.35 if entity @a[dx=0] positioned ~0.35 ~0.35 ~0.35 run function cartographer_mob_abilities:charge/needle/projectile/attack