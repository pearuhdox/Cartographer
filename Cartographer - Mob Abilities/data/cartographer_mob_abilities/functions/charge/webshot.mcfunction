...
execute unless entity @s[scores={ability_charge=2}] run execute as @e[tag=webshot_marker,distance=..2,limit=1] at @s run execute positioned ~ ~1 ~ run function cartographer_mob_abilities:charge/webshot/raycast
