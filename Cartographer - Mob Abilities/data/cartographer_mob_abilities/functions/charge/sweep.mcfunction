...
execute if score @s ability_charge matches 9 facing entity @p feet rotated ~ 0 positioned ~ ~0.75 ~ run function cartographer_mob_abilities:charge/sweep/place_lines
execute if score @s ability_charge matches 9 facing entity @p feet rotated ~ 0 positioned ~ ~0.5 ~ run function cartographer_mob_abilities:charge/sweep/warn
