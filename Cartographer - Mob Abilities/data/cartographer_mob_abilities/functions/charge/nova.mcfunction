...
execute if score @s ability_charge matches 1..21 if entity @s[tag=ca.pulse] run scoreboard players set @s mob_move_red 10
...
execute if score @s ability_charge matches 1 if entity @s[tag=ca.pulse] run function cartographer_mob_abilities:charge/nova/pulse/vfx
execute if score @s ability_charge matches 21 if entity @s[tag=ca.pulse] run function cartographer_mob_abilities:charge/nova/pulse/vfx

execute if score @s ability_charge matches 1 unless entity @s[tag=ca.pulse] run function cartographer_mob_abilities:charge/nova/normal/vfx
execute if score @s ability_charge matches 21 unless entity @s[tag=ca.pulse] run function cartographer_mob_abilities:charge/nova/normal/vfx
