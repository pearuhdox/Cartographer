...
execute unless entity @s[scores={ability_charge=2}] run scoreboard players set @s mob_move_dis 23
...
execute if entity @s[scores={ability_charge=3}] run function cartographer_mob_abilities:abilities/magic_missile/cast