...
execute unless entity @s[scores={ability_charge=2}] run execute as @e[tag=charge_marker,distance=..2,limit=1] at @s run function cartographer_mob_abilities:charge/charge/marker
