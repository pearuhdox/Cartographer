...
execute if score @s ability_charge matches 1..3 run data modify storage cartographer_mob_abilities:info grenadier.Tags append value "grenadier_projectile"
...
execute if score @s ability_charge matches 1..3 as @e[tag=grenadier_projectile,tag=!aimed] at @s run function cartographer_mob_abilities:charge/grenadier/projectile/aim
