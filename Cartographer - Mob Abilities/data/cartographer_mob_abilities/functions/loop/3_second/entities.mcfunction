...
execute as @s[type=#cartographer_core:hostile,tag=ca.breaker] at @s run function cartographer_mob_abilities:passive/breaker
...
#execute as @s[type=#cartographer_core:hostile,tag=can_see_player,tag=!tokened,tag=!priority_tokened] at @s if entity @a[distance=..30] run function cartographer_mob_abilities:helper/token/take
execute if score $global helper_diff matches 3.. as @s[type=#cartographer_core:hostile,tag=can_see_player,tag=!tokened,tag=!priority_tokened] at @s if entity @a[distance=..30] run function cartographer_mob_abilities:helper/token/take
