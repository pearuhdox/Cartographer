...
#execute if entity @s[tag=ca.check_has_effect] run function cartographer_mob_abilities:passive/block_player_tag/remove

#Check the effects of all players and assign tags
#execute if predicate cartographer_mob_abilities:block_effects/has_tracked_effect_previously run function cartographer_mob_abilities:passive/block_player_tag/add
