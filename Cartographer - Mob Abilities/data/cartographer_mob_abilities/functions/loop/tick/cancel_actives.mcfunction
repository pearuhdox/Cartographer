...
execute if entity @s[tag=ca.sweep,tag=tokened,scores={cooldown=0}] unless entity @a[gamemode=!spectator,gamemode=!creative,distance=..10] run function cartographer_mob_abilities:helper/token/cancel_ability
