...
execute unless score @s ca.acro_cooldown matches 1.. if entity @a[gamemode=!spectator,gamemode=!creative,distance=..32] run function cartographer_mob_abilities:loop/tick/do_actives
