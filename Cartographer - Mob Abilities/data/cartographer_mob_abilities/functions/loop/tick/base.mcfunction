...
execute unless entity @a[tag=token_reset] run function cartographer_mob_abilities:load/token_reset

execute if entity @a[scores={ca.logout=1..}] run function cartographer_mob_abilities:load/token_reset
