...
execute if entity @s[type=creeper,tag=ca.block_effects,tag=!ca.block_effects_creeper_applied] run function cartographer_mob_abilities:passive/block_effects/creepers/apply_creeper
execute if entity @s[type=creeper,tag=ca.block_effects_creeper_applied] run scoreboard players set $block_effects_creeper ca.var 2
