...
execute if score $deathbomb_creeper ca.var matches 1.. as @s[nbt={Effects:[{Id:32,Amplifier:127b}]}] at @s run function cartographer_mob_abilities:passive/deathbomb/kill_clouds
