...
execute if score $deathbomb_creeper ca.var matches 1.. as @s[nbt={effects:[{id:"minecraft:hero_of_the_village",amplifier:127b}]}] at @s run function cartographer_mob_abilities:death/deathbomb/kill_clouds
execute if score $block_effects_creeper ca.var matches 1.. as @s[nbt={effects:[{id:"minecraft:hero_of_the_village",amplifier:127b}]}] at @s run function cartographer_mob_abilities:passive/block_effects/creepers/kill_clouds
