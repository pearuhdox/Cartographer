...
tellraw @s [{"text":"Description: ","color":"green","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}},{"text":"When the enemy dies, they drop 2-3 copies of their offhand egg as Corpse Crawler eggs. After 3 seconds, the eggs hatch into the corresponding mob (with a baby zombie variant if no mob was specified). Eggs have 8 health, and can be destroyed by any attacks, preventing the spawn.","color":"#FFF4D9","italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}}]
tellraw @s [{"text":" ","color":"#FFF4D9","italic":false}]
