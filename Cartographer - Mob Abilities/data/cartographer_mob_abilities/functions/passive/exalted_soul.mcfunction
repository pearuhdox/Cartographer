...
execute unless entity @e[type=armor_stand,tag=exalted_weapon,sort=nearest,limit=1,distance=..0.5] anchored eyes facing entity @e[type=armor_stand,tag=exalted_weapon,sort=nearest,limit=1,distance=0.4..] feet positioned ^ ^ ^0.8 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^0.15 ~ ~
...
execute if score @s exalted matches 80.. if entity @e[type=armor_stand,tag=exalted_weapon,distance=..0.5] run kill @e[type=sheep,tag=exalted_soul_hitbox,distance=..0.5]
...
execute if score @s exalted matches 80.. if entity @e[type=armor_stand,tag=exalted_weapon,distance=..0.5] run kill @s
