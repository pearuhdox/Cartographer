...
execute if entity @s[type=#cartographer_mob_abilities:sb_vex] run scoreboard players set $reduced_power ca.xyz_convert 3

function cartographer_mob_abilities:projectiles/create/enderpearl
