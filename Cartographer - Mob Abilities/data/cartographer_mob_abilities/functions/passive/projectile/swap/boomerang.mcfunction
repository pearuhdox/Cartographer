...
execute if entity @s[type=#cartographer_mob_abilities:sb_vex] as 0000001f-00de-140d-0000-0000000276ef at @s run tp @s ~ ~1 ~

function cartographer_mob_abilities:projectiles/create/boomerang
