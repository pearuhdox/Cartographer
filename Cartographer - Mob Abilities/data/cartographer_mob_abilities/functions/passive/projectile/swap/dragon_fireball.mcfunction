...
execute if entity @s[type=shulker_bullet] unless entity @a[distance=..4] as 0000001f-00de-140d-0000-0000000276ef at @s run tp @s ~ ~1 ~
execute if entity @s[type=shulker_bullet] run scoreboard players set $reduced_power ca.xyz_convert 2
