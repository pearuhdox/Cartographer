...
execute if entity @s[type=#cartographer_mob_abilities:sb_vex] unless entity @a[distance=..4] as 0000001f-00de-140d-0000-0000000276ef at @s run tp @s ~ ~1 ~
execute if entity @s[type=#cartographer_mob_abilities:sb_vex] run scoreboard players set $reduced_power ca.xyz_convert 2

function cartographer_mob_abilities:projectiles/create/dragon_fireball
