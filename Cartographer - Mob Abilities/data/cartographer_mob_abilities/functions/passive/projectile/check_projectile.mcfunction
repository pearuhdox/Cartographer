...
execute as @s[type=!ghast,tag=ca.shoot_dragon_fireball] at @s as @e[type=#cartographer_core:projectile,tag=!passive_replaced_projectile,limit=3,distance=..4,sort=nearest] unless score @s ca.lifetime matches 0.. run function cartographer_mob_abilities:passive/projectile/dragon_fireball
...
execute as @s[type=ghast,tag=ca.shoot_dragon_fireball] at @s as @e[type=#cartographer_core:projectile,tag=!passive_replaced_projectile,limit=1,distance=..6,sort=nearest] unless score @s ca.lifetime matches 0.. run function cartographer_mob_abilities:passive/projectile/dragon_fireball_ghast
