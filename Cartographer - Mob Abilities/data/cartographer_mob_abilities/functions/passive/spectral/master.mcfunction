...
function cartographer_mob_abilities:passive/spectral/find_type

function cartographer_mob_abilities:passive/spectral/summon

execute as @e[tag=ca.spectre,tag=!spectre_checked,limit=1,sort=nearest] at @s run function cartographer_mob_abilities:passive/spectral/data
