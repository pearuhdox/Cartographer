...
execute if data storage cartographer_mob_abilities:summoner data.id as @e[type=item,tag=new_spectre_item,distance=..1,limit=1,sort=nearest] run function cartographer_mob_abilities:passive/spectral/setup_egg
