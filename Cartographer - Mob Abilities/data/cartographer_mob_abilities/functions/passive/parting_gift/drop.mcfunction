...
function cartographer_mob_abilities:passive/parting_gift/determine_traits
...
#Spawn Clusters
execute unless score $volatile ca.death_traits matches 1 if score $cluster ca.death_traits matches 1 run function cartographer_mob_abilities:passive/parting_gift/cluster_setup
...
execute as @e[type=armor_stand,tag=ca.new_drop,limit=3] run function cartographer_mob_abilities:passive/parting_gift/spawn
