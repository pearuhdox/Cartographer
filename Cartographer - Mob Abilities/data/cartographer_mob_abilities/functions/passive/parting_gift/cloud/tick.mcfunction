...
execute positioned ~-1.75 ~ ~-1.75 if entity @a[dx=3,dy=0.01,dz=3,tag=ability_tagged] positioned ~1.75 ~ ~1.75 run function cartographer_mob_abilities:passive/parting_gift/cloud/detonate
