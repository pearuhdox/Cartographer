...
execute anchored eyes as @e[tag=!ca.soul_chained,tag=!ca.soul_chain_start,tag=ca.soul_chain,distance=..1.5,limit=1,sort=nearest] at @s anchored eyes run function cartographer_mob_abilities:passive/soul_chain/setup_continue