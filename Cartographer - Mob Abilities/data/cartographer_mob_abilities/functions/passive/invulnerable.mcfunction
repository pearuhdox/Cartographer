...
summon armor_stand ^ ^1.5 ^1 {CustomNameVisible:1b,NoGravity:1b,Marker:1b,Invisible:1b,Tags:["invulnerable_notice"],CustomName:'{"text":"🛡 Invincible 🛡","color":"#99453A","bold":true,"italic":false}'}