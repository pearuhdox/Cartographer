scoreboard players add @e[type=#cartographer_core:hostile,distance=..16] brutal_stacks 1

execute as @e[type=#cartographer_core:hostile,distance=..16] at @s run particle minecraft:dust 1 0 0 1 ~ ~1 ~ 0.5 0.5 0.5 0 15 normal
