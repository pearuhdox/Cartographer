...
execute if score $target_health bbl.storage matches ..0 run function cartographer_mob_abilities:passive/size/grow/kill_grow
execute unless score $target_health bbl.storage matches ..0 run function cartographer_mob_abilities:passive/size/grow/do_grow