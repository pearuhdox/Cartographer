...
execute if score @s ca.size_changed_stacks matches 1 run attribute @s minecraft:generic.attack_damage modifier add 31199265-1981-8914-1100-000000000000 "increased_size" 0.3 multiply
execute if score @s ca.size_changed_stacks matches 2 run attribute @s minecraft:generic.attack_damage modifier add 31199265-1981-8914-1100-000000000000 "increased_size" 0.6 multiply
execute if score @s ca.size_changed_stacks matches 3 run attribute @s minecraft:generic.attack_damage modifier add 31199265-1981-8914-1100-000000000000 "increased_size" 0.9 multiply
execute if score @s ca.size_changed_stacks matches 4 run attribute @s minecraft:generic.attack_damage modifier add 31199265-1981-8914-1100-000000000000 "increased_size" 1.2 multiply
execute if score @s ca.size_changed_stacks matches 5.. run attribute @s minecraft:generic.attack_damage modifier add 31199265-1981-8914-1100-000000000000 "increased_size" 1.5 multiply
