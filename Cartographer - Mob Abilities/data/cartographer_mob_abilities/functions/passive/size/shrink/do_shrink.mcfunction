...
scoreboard players operation $shrink_val ca.mob_var *= $size_max_range ca.mob_var

scoreboard players operation $shrink_val ca.mob_var /= $100 ca.CONSTANT

scoreboard players operation $shrink_val ca.mob_var += @s ca.size_min

execute if score $shrink_val ca.mob_var > @s ca.size_max run scoreboard players operation $shrink_val ca.mob_var = @s ca.size_max
...
execute unless score @s ca.size_cur = $shrink_val ca.mob_var run function cartographer_mob_abilities:passive/size/shrink/did_shrink

scoreboard players operation @s ca.size_cur = $shrink_val ca.mob_var