...
execute if entity @s[tag=ca.glacial] align xyz positioned ~0.5 ~ ~0.5 run summon area_effect_cloud ~ ~0.3 ~ {Particle:"snowflake",ReapplicationDelay:20,Radius:0.5f,RadiusPerTick:0.04f,RadiusOnUse:0f,Duration:100,DurationOnUse:0f,Age:0,WaitTime:15,Potion:"minecraft:awkward",effects:[{id:"minecraft:slowness",amplifier:1b,duration:80}]}
...
execute if entity @s[tag=ca.zephyrous] align xyz positioned ~0.5 ~ ~0.5 run summon area_effect_cloud ~ ~0.3 ~ {Particle:"cloud",ReapplicationDelay:20,Radius:0.5f,RadiusPerTick:0.04f,RadiusOnUse:0f,Duration:100,DurationOnUse:0f,Age:0,WaitTime:15,Potion:"minecraft:awkward",effects:[{id:"minecraft:levitation",amplifier:5b,duration:40}]}
