...
loot replace entity @s armor.feet 4 mine 4206900 77 4206900 air{drop_contents:1b}

data modify block 4206900 77 4206900 Items set from storage inv:main inv.offhand
loot replace entity @s weapon.offhand 1 mine 4206900 77 4206900 air{drop_contents:1b}