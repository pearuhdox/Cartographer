...
execute if score @s ca.possess_time matches 60 if entity @s[type=!#cartographer_core:undead] at @s run summon area_effect_cloud ~ ~ ~ {Tags:["possession_cloud"],Duration:10,DurationOnUse:0,WaitTime:0,Particle:"block air",Effects:[{Id:7b,Duration:10,Amplifier:31b,ShowParticles:0b}],Radius:1.0f,RadiusOnUse:0.0f,RadiusPerTick:0.0f}
execute if score @s ca.possess_time matches 60 if entity @s[type=#cartographer_core:undead] at @s run summon area_effect_cloud ~ ~ ~ {Tags:["possession_cloud"],Duration:10,DurationOnUse:0,WaitTime:0,Particle:"block air",Effects:[{Id:6b,Duration:10,Amplifier:31b,ShowParticles:0b}],Radius:1.0f,RadiusOnUse:0.0f,RadiusPerTick:0.0f}
execute if score @s ca.possess_time matches 60 at @s run data modify entity @e[type=area_effect_cloud,tag=possession_cloud,limit=1,sort=nearest] Owner set from entity @e[type=#cartographer_core:hostile,distance=0.75..16,sort=nearest,limit=1] UUID
