...
#execute if score @s ca.eft_possess matches 1 as @e[type=arrow,tag=enrager,limit=1,sort=nearest] run data modify entity @s Owner set from entity @e[limit=1,type=#cartographer_core:hostile,sort=nearest,distance=1..10] UUID
