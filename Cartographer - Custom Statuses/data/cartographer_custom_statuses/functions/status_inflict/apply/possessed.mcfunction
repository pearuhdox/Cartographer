...
execute unless score $value bbl.rng > $chance ca.possess_time unless entity @s[tag=ca.boss] unless entity @s[tag=ca.possess_attempted] run scoreboard players set $do_chance ca.status_var 2

execute unless score $value bbl.rng > $chance ca.possess_time unless entity @s[tag=ca.boss] unless entity @s[tag=ca.possess_attempted] unless score @s ca.possess_immune matches 1.. run scoreboard players set $do_chance ca.status_var 1
