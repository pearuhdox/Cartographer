execute if score $bleed ca.stat_calc_var matches 0.. run data modify storage cartographer_custom_statuses:apply_status data.effects append value {id:"bleeding",Amount:0,chance:100}
...
execute if score $shock_chance ca.stat_calc_var matches 1.. store result storage cartographer_custom_statuses:apply_status data.effects[{id:"shocking"}].chance int 1 run scoreboard players get $shock_chance ca.stat_calc_var

execute if score $infect ca.stat_calc_var matches 1.. store result storage cartographer_custom_statuses:apply_status data.effects[{id:"infection"}].duration int 1 run scoreboard players get $infect ca.stat_calc_var
execute if score $infect_chance ca.stat_calc_var matches 1.. store result storage cartographer_custom_statuses:apply_status data.effects[{id:"infection"}].chance int 1 run scoreboard players get $infect_chance ca.stat_calc_var

execute if score $stun_time ca.stat_calc_var matches 1.. store result storage cartographer_custom_statuses:apply_status data.effects[{id:"stun"}].duration int 1 run scoreboard players get $stun_time ca.stat_calc_var
execute if score $stun_time ca.stat_calc_var matches 1.. store result storage cartographer_custom_statuses:apply_status data.effects[{id:"stun"}].chance int 1 run scoreboard players get $stun_chance ca.stat_calc_var
