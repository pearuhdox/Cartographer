...
scoreboard players operation $target ca.rand_var = $chance ca.effect_shock
...
execute if score $do_chance ca.status_var matches 1.. run scoreboard players add @s ca.effect_shock 2
