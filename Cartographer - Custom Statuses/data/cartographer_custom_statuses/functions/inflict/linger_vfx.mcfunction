...
execute if score @s ca.lifetime matches 401..600 if score @s ca.effect_shackled matches 1.. run particle minecraft:dust 0.255 0.322 0.306 0.75 ~ ~-0.2 ~ 1.25 0.1 1.25 0 7 normal
...
execute if score @s ca.lifetime matches 201..400 if score @s ca.effect_shackled matches 1.. run particle minecraft:dust 0.255 0.322 0.306 0.75 ~ ~-0.2 ~ 0.85 0.1 0.85 0 7 normal
...
execute if score @s ca.lifetime matches 1..200 if score @s ca.effect_shackled matches 1.. run particle minecraft:dust 0.255 0.322 0.306 0.75 ~ ~-0.2 ~ 0.45 0.1 0.45 0 7 normal
