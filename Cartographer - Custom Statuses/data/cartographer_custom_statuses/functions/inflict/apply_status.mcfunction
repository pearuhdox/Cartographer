...
execute if entity @s[scores={ca.id_convert=12,ca.effect_infect=1..}] run scoreboard players add @s ca.effect_infect 1
...
execute if score @s ca.id_convert matches 10..20 run effect clear @s nausea