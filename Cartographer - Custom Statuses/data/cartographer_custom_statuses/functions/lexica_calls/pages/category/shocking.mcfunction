...
tellraw @s [{"text":"Description: ","color":"green","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}},{"text":"Afflicted mobs take 1 damage per second, and deal 1 damage per second to the closest 3 mobs within 3.5 blocks. Every third tick deals 3 damage instead, and stuns the primary target, knocking back the group targets. Targets in water accelerate the increased effect to every other damage tick instead of every 3 damage ticks. Multiple shocked enemies can deal damage to each other at the same time.","color":"#FFF4D9","italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}}]
tellraw @s [{"text":" ","color":"#FFF4D9","italic":false}]
