...
execute if entity @s[advancements={cartographer_custom_statuses:cloaked=true}] run tellraw @s [{"text":"---[➤] ","color":"#FFF4D9","bold":true,"italic":false},{"bold":false,"text":"Cloaking","color":"#57dec0","italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"View information for Cloaking.","color":"#FFF4D9","italic":true}]},"clickEvent":{"action":"run_command","value":"/trigger ca.lexica_trig set 103"}}]
execute if entity @s[advancements={cartographer_custom_statuses:possess=true}] run tellraw @s [{"text":"---[➤] ","color":"#FFF4D9","bold":true,"italic":false},{"bold":false,"text":"Possession","color":"#57dec0","italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"View information for Possession.","color":"#FFF4D9","italic":true}]},"clickEvent":{"action":"run_command","value":"/trigger ca.lexica_trig set 104"}}]
execute if entity @s[advancements={cartographer_custom_statuses:morph=true}] run tellraw @s [{"text":"---[➤] ","color":"#FFF4D9","bold":true,"italic":false},{"bold":false,"text":"Morph","color":"#57dec0","italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"View information for Morph.","color":"#FFF4D9","italic":true}]},"clickEvent":{"action":"run_command","value":"/trigger ca.lexica_trig set 109"}}]
