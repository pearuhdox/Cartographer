...
execute as @s[scores={effect_rage=1}] at @s run summon arrow ~ ~2.3 ~ {Tags:["enrager"],Motion:[0.0,-1.0,0.0],damage:0,life:1200}
...
execute at @s[scores={effect_rage=1..}] run particle minecraft:angry_villager ~ ~2.25 ~ 0.2 0.2 0.2 0 1 force