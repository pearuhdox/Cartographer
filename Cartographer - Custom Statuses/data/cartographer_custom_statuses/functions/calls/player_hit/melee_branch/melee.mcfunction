...
execute if entity @s[tag=ca.override_melee_h,tag=ca.as_head] run function cartographer_custom_statuses:apply_self/save/override/head
execute if entity @s[tag=ca.override_melee_b,tag=ca.as_body] run function cartographer_custom_statuses:apply_self/save/override/body
execute if entity @s[tag=ca.override_melee_l,tag=ca.as_legs] run function cartographer_custom_statuses:apply_self/save/override/legs
execute if entity @s[tag=ca.override_melee_f,tag=ca.as_feet] run function cartographer_custom_statuses:apply_self/save/override/feet
execute if entity @s[tag=ca.override_melee_o,tag=ca.as_offh] run function cartographer_custom_statuses:apply_self/save/override/offhand
execute if entity @s[tag=ca.override_melee_m,tag=ca.as_main] run function cartographer_custom_statuses:apply_self/save/override/mainhand
