...
execute if score $no_lexica_prompt ca.gamerule matches 0 run tellraw @s [{"text":"❰ ","color":"green","bold":true,"italic":false},{"text":"Afflictions ","color":"#CC73FF","italic":false},{"text":"❱ ","bold":true,"italic":false},{"text":"Bleeding","color":"yellow","bold":false,"italic":false,"underlined":true,"hoverEvent":{"action":"show_text","contents":[{"text":"Description: ","color":"white","italic":false},{"text":"Afflicted takes damage every second based on the level of Bleeding. If Bleeding is reapplied, the potency is increased, instead of resetting the duration.","color":"gray","italic":false}]}},{"text":" has been discovered!","color":"#ACFFA6","bold":false,"italic":false}]
