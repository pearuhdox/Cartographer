...
execute if entity @s[scores={random=61..80}] unless entity @s[tag=shocked_tick] as @e[type=#cartographer_core:hostile,distance=..3,limit=3,sort=nearest,tag=!shocked_tick] at @s run function cartographer_core:helper/push_third
...
execute as @e[type=#cartographer_core:hostile,distance=0.5..3,limit=3,sort=nearest,tag=!shocked_tick] at @s unless entity @s[scores={effect_shocked=1..}] run function cartographer_custom_statuses:effects/shocked_neighbors
