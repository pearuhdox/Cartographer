...
execute if score @s ca.cs_shoot_bow matches 1.. run function cartographer_custom_statuses:effects/player/check_ranged_attack
execute if score @s ca.cs_shoot_cross matches 1.. run function cartographer_custom_statuses:effects/player/check_ranged_attack
#execute if score @s ca.cs_throw_trident matches 1.. run function cartographer_custom_statuses:effects/player/check_ranged_attack
