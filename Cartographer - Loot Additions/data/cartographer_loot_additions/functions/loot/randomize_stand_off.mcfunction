...
data modify entity @e[type=chicken,tag=chicken_loot_random,limit=1] DeathLootTable set from entity @s HandItems[1].tag.EntityTag.DeathLootTable

loot insert 4206900 10 4206900 kill @e[type=chicken,tag=chicken_loot_random,limit=1]

data remove entity @s HandItems[1]

data modify entity @s HandItems[1] set from block 4206900 10 4206900 Items[0]

kill @e[type=chicken,tag=chicken_loot_random]

tag @s remove random_off
