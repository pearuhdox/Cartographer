...
data modify entity @e[type=chicken,tag=chicken_loot_random,limit=1] DeathLootTable set from entity @s Item.tag.EntityTag.DeathLootTable

loot insert 4206900 10 4206900 kill @e[type=chicken,tag=chicken_loot_random,limit=1]

data remove entity @s Item.id

data modify entity @s Item set from block 4206900 10 4206900 Items[0]
