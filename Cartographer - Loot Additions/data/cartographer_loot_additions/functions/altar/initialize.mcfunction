...
summon item_frame ~ ~2 ~ {Glowing:1b,Silent:1b,CustomNameVisible:1b,Facing:1b,Tags:["ca.la.tracked","loot_altar_holder","loot_holder"],CustomName:'{"text":"Loot Placeholder","italic":false}',Item:{}}
