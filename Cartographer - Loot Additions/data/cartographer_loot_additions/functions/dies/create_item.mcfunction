...
execute if block ~ ~-1 ~ budding_amethyst if entity @e[type=minecraft:item_frame,distance=..2,limit=1,sort=nearest,tag=dies.target,tag=ca.budding_item] at @s run function cartographer_loot_additions:budding/establish
