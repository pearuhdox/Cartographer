...
execute if block ~ ~-1 ~ chest[facing=south] as @e[type=item_display,tag=ca.soul_chest,sort=nearest,limit=1] at @s run tp @s ~ ~ ~ ~180 ~
execute if block ~ ~-1 ~ chest[facing=west] as @e[type=item_display,tag=ca.soul_chest,sort=nearest,limit=1] at @s run tp @s ~ ~ ~ ~270 ~
execute if block ~ ~-1 ~ chest[facing=north] as @e[type=item_display,tag=ca.soul_chest,sort=nearest,limit=1] at @s run tp @s ~ ~ ~ ~0 ~
execute if block ~ ~-1 ~ chest[facing=east] as @e[type=item_display,tag=ca.soul_chest,sort=nearest,limit=1] at @s run tp @s ~ ~ ~ ~90 ~
