summon item_frame ~ ~1 ~ {Glowing:1b,Silent:1b,CustomNameVisible:1b,Facing:1b,Tags:["ca.belongs_la","ca.la.tracked","loot_holder_ground","loot_holder"],CustomName:'{"text":"Loot Placeholder","italic":false}',Item:{}}
