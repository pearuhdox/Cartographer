...
execute if entity @e[type=#bb:explosive,distance=..3,limit=1] run scoreboard players set $loot_frame_explosion ca.var 1
execute if entity @e[type=#bb:explosive,distance=3..6,limit=1] unless entity @a[distance=..1.5] run scoreboard players set $loot_frame_explosion ca.var 1
