...
execute as @e[type=interaction,tag=ca.hungry_chest_interaction,distance=..5] at @s run function cartographer_loot_additions:hungry_chest/interact/verify_left

advancement revoke @s only cartographer_loot_additions:interact_hungry/left