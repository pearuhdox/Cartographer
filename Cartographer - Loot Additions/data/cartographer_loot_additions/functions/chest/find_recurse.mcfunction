...
execute if entity @s[scores={ca.raycast=1..}] unless block ^ ^ ^0.3 #bb:containers as @s positioned ^ ^ ^0.3 run function cartographer_loot_additions:chest/find_recurse