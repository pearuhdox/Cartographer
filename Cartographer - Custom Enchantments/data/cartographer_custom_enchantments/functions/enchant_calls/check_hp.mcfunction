...
execute if score $percentage_health_remaining bbl.storage matches 51..99 as @s at @s run function cartographer_custom_enchantments:enchant_calls/check_hp/above_50