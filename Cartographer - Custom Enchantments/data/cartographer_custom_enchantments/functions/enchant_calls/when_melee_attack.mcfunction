#Concealed Consume - Unaffected by Fizzling
...
# Fast Attack - Unaffected by Fizzling
...
#Momentum Attack - Unaffected by Fizzling
...
#Do Fizzling Check
execute unless score @s ca.curse_fizzling_main matches 1.. run function cartographer_custom_enchantments:enchant_calls/when_melee_attack_branch
...
execute if score @s ca.curse_fizzling_main matches 1.. if score $success ca.rand_var matches 1.. run function cartographer_custom_enchantments:enchant_calls/when_melee_attack_branch
