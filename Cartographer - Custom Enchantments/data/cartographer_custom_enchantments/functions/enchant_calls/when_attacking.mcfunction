...
#Gravity
execute if score @s ca.gravity matches 1.. if score @s ca.gravity_time matches 2.. if entity @s[tag=ca.gravity_falling] run function cartographer_custom_enchantments:enchant_effects/gravity/landed
