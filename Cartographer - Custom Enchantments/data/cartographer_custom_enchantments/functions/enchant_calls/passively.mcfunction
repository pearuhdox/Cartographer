...
execute as @a[scores={ca.second_wind=1..}] at @s run function cartographer_custom_enchantments:enchant_effects/second_wind

#Evasion
execute as @a[scores={ca.evasion=1..},tag=evading] at @s run function cartographer_custom_enchantments:enchant_effects/evasion
...
#Spurs
execute as @a[scores={ca.spurs=1..}] at @s if block ~ ~ ~ #cartographer_custom_enchantments:spurs run function cartographer_custom_enchantments:enchant_effects/spurs
execute as @a[scores={ca.spurs=1..}] at @s if block ~ ~1 ~ #cartographer_custom_enchantments:spurs run function cartographer_custom_enchantments:enchant_effects/spurs

execute as @a[scores={ca.spurs=1..}] at @s if block ~0.75 ~ ~ #cartographer_custom_enchantments:spurs run function cartographer_custom_enchantments:enchant_effects/spurs
execute as @a[scores={ca.spurs=1..}] at @s if block ~0.75 ~1 ~ #cartographer_custom_enchantments:spurs run function cartographer_custom_enchantments:enchant_effects/spurs

execute as @a[scores={ca.spurs=1..}] at @s if block ~ ~ ~0.75 #cartographer_custom_enchantments:spurs run function cartographer_custom_enchantments:enchant_effects/spurs
execute as @a[scores={ca.spurs=1..}] at @s if block ~ ~1 ~0.75 #cartographer_custom_enchantments:spurs run function cartographer_custom_enchantments:enchant_effects/spurs
...
execute as @a[scores={ca.spurs=1..}] at @s if block ~0.75 ~ ~0.75 #cartographer_custom_enchantments:spurs run function cartographer_custom_enchantments:enchant_effects/spurs
execute as @a[scores={ca.spurs=1..}] at @s if block ~0.75 ~1 ~0.75 #cartographer_custom_enchantments:spurs run function cartographer_custom_enchantments:enchant_effects/spurs
