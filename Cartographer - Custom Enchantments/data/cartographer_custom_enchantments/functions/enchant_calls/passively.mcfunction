...
execute if entity @s[nbt=!{active_effects:[{id:"minecraft:hunger"}]}] run function cartographer_custom_enchantments:enchant_effects/cleansing
...
execute as @s[scores={ca.repeating=1..7},nbt={SelectedItem:{tag:{Ammo:-1}}}] at @s run item modify entity @s weapon.mainhand cartographer_custom_enchantments:fix_ammo
execute as @s[scores={ca.repeating=11..17},nbt={Inventory:[{Slot:-106b,tag:{Ammo:-1}}]}] at @s run item modify entity @s weapon.offhand cartographer_custom_enchantments:fix_ammo
