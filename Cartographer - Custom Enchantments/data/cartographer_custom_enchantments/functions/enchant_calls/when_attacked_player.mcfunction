...
#Concealed
execute if entity @s[scores={concealed=1..,helper_damaged=1..,ca.conceal_time=80..}] run function cartographer_custom_enchantments:enchant_effects/concealed_consume