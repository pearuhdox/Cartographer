...
tellraw @s [{"text":"Cauterize","color":"yellow","bold":true,"italic":false}]
tellraw @s [{"text":" ","color":"#FFF4D9","italic":false}]

tellraw @s [{"text":"Description: ","color":"green","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}},{"text":"When the holder or wearer attacks a mob that is on fire (ranged or melee attack) the mob is extinguished, dealt half the damage of the remaining fire tick in one burst, and made Brittle for equal time to the fire duration. Brittle enemies take 100% damage and extra knockback from the next attack they receive. If an enemy cannot be set on fire, Cauterize instead just deals additional 2.5 damage to the mob.","color":"#FFF4D9","italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}}]
tellraw @s [{"text":" ","color":"#FFF4D9","italic":false}]
