...
tellraw @s [{"text":"Description: ","color":"green","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}},{"text":"While you have no Absorption Health, you will be protected from a lethal attack, cleansing all potion effects. When you are, your fatal hit protection is removed, and you receive a 'Fatal Shield' which lasts for at most 10 seconds. While you have this Fatal Shield, killing a mob will restore health equal to the remaining value of the shield and restore your fatal hit protection (cleansing the shield). If the Fatal Shield runs out, either by being damaged or running out of time, the player is instead dealt a heavy instance of damage, 20% of which is 'true damage'. Successive triggers of Second Wind reduce the starting shield value by 4 (minimum of 4), reduce the starting duration by 3 seconds (minimum of 4), and increase the damage dealt by 15.","color":"#FFF4D9","italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}}]
tellraw @s [{"text":" ","color":"#FFF4D9","italic":false}]
