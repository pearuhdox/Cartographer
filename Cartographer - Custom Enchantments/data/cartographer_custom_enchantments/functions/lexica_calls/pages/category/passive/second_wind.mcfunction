...
tellraw @s [{"text":"Description: ","color":"green","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}},{"text":"While worn/held, you will be protected from a lethal hit. When you are hit for lethal damage, you gain 10 seconds of brief invulnerability. During this time, every mob that is targeting you within 16 blocks will be marked. If every marked mob dies before your invulnerability runs out, you are healed and saved from death. If not every marked mob dies, you die at the end of your invulnerability. If you die and there are no nearby hostile mobs, Second Wind will not activate.","color":"#FFF4D9","italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}}]
tellraw @s [{"text":" ","color":"#FFF4D9","italic":false}]
