...
tellraw @s [{"text":"Description: ","color":"green","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}},{"text":"While you have no Absorption Health, you will be protected from a lethal attack, cleansing all potion effects. When you are, your fatal hit protection is removed, and you receive Absorption Health which lasts for at most 10 seconds. While you have Absorption Health (in this state), killing a mob will restore health equal to your Absorption Health, give back your fatal hit protection, and remove all your Absorption. When you run out of Absorption Health, either by being damaged or running out of time, you are dealt extremely high damage. Successive triggers of Second Wind reduce the Absorption shield amount, reduce the Absorption shield duration by 3 seconds (minimum of 4), and increase the penalty damage considerably.","color":"#FFF4D9","italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}}]
tellraw @s [{"text":" ","color":"#FFF4D9","italic":false}]
