...
tellraw @s [{"text":"Description: ","color":"green","bold":false,"italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}},{"text":"Ranged attacks with this trident that hit spawners spawn a Collapse entity that breaks the spawner over the next 5 seconds. The player must stay close to the Collapse entity otherwise it will despawn. Efficiency, Sapper, and Eruption, as well as related synergies all apply when the spawner is broken.","color":"#FFF4D9","italic":false,"hoverEvent":{"action":"show_text","contents":[{"text":"","color":"#FFF4D9","italic":true}]}}]
tellraw @s [{"text":" ","color":"#FFF4D9","italic":false}]
