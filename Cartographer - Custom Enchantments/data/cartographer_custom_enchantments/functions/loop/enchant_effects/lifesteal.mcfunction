...
execute if entity @s[scores={lifesteal=3,helper_kill=1..}] run function cartographer_core:helper/heal_player/3
execute if entity @s[scores={lifesteal=4,helper_kill=1..}] run function cartographer_core:helper/heal_player/4
execute if entity @s[scores={lifesteal=5,helper_kill=1..}] run function cartographer_core:helper/heal_player/5
execute if entity @s[scores={lifesteal=6,helper_kill=1..}] run function cartographer_core:helper/heal_player/6