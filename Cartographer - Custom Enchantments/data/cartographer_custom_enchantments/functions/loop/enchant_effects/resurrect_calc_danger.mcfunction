...
scoreboard players operation @s danger_lvl *= $core.negative_1 ca.CONSTANT
...
execute as @e[type=#cartographer_core:hostile,distance=..16] at @s run function cartographer_custom_enchantments:loop/enchant_effects/resurrect_calc_threat
