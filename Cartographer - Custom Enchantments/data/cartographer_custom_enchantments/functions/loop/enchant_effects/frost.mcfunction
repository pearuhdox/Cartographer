...
execute if entity @s[scores={frost=1}] run execute as @e[type=arrow,limit=3,sort=nearest,scores={helper_lifetime=1}] run data merge entity @s {Color:11783423,CustomPotionEffects:[{Id:2b,Amplifier:1b,Duration:100}],Potion:"minecraft:awkward"}