...
execute as @s[scores={helper_lifetime=1..}] at @s run execute unless entity @e[type=#cartographer_core:hostile,distance=..1.5,scores={ricochet_cool=1..}] run execute if entity @e[type=#cartographer_core:hostile,distance=..1.5,nbt={HurtTime:0s}] run effect give @e[type=#cartographer_core:hostile,distance=..1.5] wither 1 1
