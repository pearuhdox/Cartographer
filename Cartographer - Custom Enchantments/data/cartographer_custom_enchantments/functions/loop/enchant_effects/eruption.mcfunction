...
execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute if entity @s[scores={eruption=1..}] run execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute as @e[type=#cartographer_core:hostile,distance=..8] run effect give @s wither 1 1 true

execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute if entity @s[scores={eruption=1}] run execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute as @e[type=#cartographer_core:hostile,distance=..8] run function cartographer_core:helper/deal_damage/2
execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute if entity @s[scores={eruption=2}] run execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute as @e[type=#cartographer_core:hostile,distance=..8] run function cartographer_core:helper/deal_damage/5
execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute if entity @s[scores={eruption=3}] run execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute as @e[type=#cartographer_core:hostile,distance=..8] run function cartographer_core:helper/deal_damage/8
execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute if entity @s[scores={eruption=4}] run execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute as @e[type=#cartographer_core:hostile,distance=..8] run function cartographer_core:helper/deal_damage/11
execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute if entity @s[scores={eruption=5}] run execute as @s at @e[type=minecraft:experience_orb,limit=1,sort=nearest] run execute as @e[type=#cartographer_core:hostile,distance=..8] run function cartographer_core:helper/deal_damage/14
