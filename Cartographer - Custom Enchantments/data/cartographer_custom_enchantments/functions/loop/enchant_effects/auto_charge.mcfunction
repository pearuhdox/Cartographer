...
data modify block 0 0 0 Items append from storage item:load path

data modify block 0 0 0 Items[0].tag merge value {ChargedProjectiles:[{id:"minecraft:arrow",Count:1b},{},{}],Charged:1b}
...
execute if entity @s[scores={auto_charge=1}] run loot replace entity @s hotbar.0 1 mine 0 0 0 air{drop_contents:1b}
execute if entity @s[scores={auto_charge=2}] run loot replace entity @s hotbar.1 1 mine 0 0 0 air{drop_contents:1b}
execute if entity @s[scores={auto_charge=3}] run loot replace entity @s hotbar.2 1 mine 0 0 0 air{drop_contents:1b}
execute if entity @s[scores={auto_charge=4}] run loot replace entity @s hotbar.3 1 mine 0 0 0 air{drop_contents:1b}
execute if entity @s[scores={auto_charge=5}] run loot replace entity @s hotbar.4 1 mine 0 0 0 air{drop_contents:1b}
execute if entity @s[scores={auto_charge=6}] run loot replace entity @s hotbar.5 1 mine 0 0 0 air{drop_contents:1b}
execute if entity @s[scores={auto_charge=7}] run loot replace entity @s hotbar.6 1 mine 0 0 0 air{drop_contents:1b}
execute if entity @s[scores={auto_charge=8}] run loot replace entity @s hotbar.7 1 mine 0 0 0 air{drop_contents:1b}
execute if entity @s[scores={auto_charge=9}] run loot replace entity @s hotbar.8 1 mine 0 0 0 air{drop_contents:1b}
execute if entity @s[scores={auto_charge=10}] run loot replace entity @s weapon.offhand 1 mine 0 0 0 air{drop_contents:1b}
