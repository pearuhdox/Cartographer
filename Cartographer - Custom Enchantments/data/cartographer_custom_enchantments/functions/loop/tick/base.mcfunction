...
execute if entity @a[scores={curse_twohanded=2..}] as @a[scores={curse_twohanded=2..}] at @s run function cartographer_custom_enchantments:loop/enchant_effects/curse_twohanded
...
#End the Second Wind effect if a player dies.
execute if entity @a[scores={helper_deathtime=0}] as @a[scores={helper_deathtime=0}] at @s run scoreboard players set @s second_wind_cool 17
