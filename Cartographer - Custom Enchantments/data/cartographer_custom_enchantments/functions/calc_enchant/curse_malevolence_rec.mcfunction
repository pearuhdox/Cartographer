...
execute if score $temp ca.susu matches ..8 run scoreboard players add @s curse_malevolent 1
execute if score $temp ca.susu matches 100.. run scoreboard players add @s curse_malevolent 1
