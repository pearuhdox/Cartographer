execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"adrenaline"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"agility"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"aquadynamic"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"fatigue_cleansing"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"poison_cleansing"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"weakness_cleansing"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"slowness_cleansing"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"wither_cleansing"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"concealed"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"evasion"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"energetic"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"frenzy"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"steadfast"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"lifesteal"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"rally"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"regeneration"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"satiation"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"second_wind"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"spurs"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"thorns"}].lvl
...
execute if score $temp ca.susu matches 1.. run tag @s add ca.ce_thorns_feet

execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"resourceful"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"momentum"}].lvl
...
execute if score $temp ca.susu matches 1.. run tag @s add ca.ce_momentum_feet

execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"quake"}].lvl
...
execute if score $temp ca.susu matches 1.. run tag @s add ca.ce_quake_feet

execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"gravity"}].lvl
...
execute if score $temp ca.susu matches 1.. run tag @s add ca.ce_gravity_feet

execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"starfall"}].lvl
...
execute if score $temp ca.susu matches 1.. run tag @s add ca.ce_starfall_feet

execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"deadeye"}].lvl
...
execute if score $temp ca.susu matches 1.. run tag @s add ca.ce_deadeye_feet

execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"stalwart"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"poise"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"shielding"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"sprint_dash"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"disengage"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"curse_regret"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"curse_clumsiness"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"curse_flammability"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"curse_jinxing"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"curse_drowning"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"curse_fizzling"}].lvl
execute if score $temp ca.susu matches 1.. store result score $cu_en_passive ca.enabler run scoreboard players operation @s ca.curse_fizzling += $temp ca.susu

execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.Enchantments[{id:"minecraft:respiration"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.Enchantments[{id:"minecraft:swift_sneak"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.Enchantments[{id:"minecraft:soul_speed"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomAttributes[{id:"ranged_flat"}].amount 10
execute if score $temp ca.susu matches 1.. run scoreboard players operation @s ca.attr_ranged += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomAttributes[{id:"ranged_percent"}].amount 100
execute unless score $temp ca.susu matches 0 run scoreboard players operation @s ca.attr_ranged_perc += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomAttributes[{id:"ranged_speed"}].amount 100
execute unless score $temp ca.susu matches 0 run scoreboard players operation @s ca.attr_ranged_speed += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomAttributes[{id:"potion_size"}].amount 10
execute unless score $temp ca.susu matches 0 run scoreboard players operation @s ca.attr_potion_size += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomAttributes[{id:"random_crit"}].amount 100
execute unless score $temp ca.susu matches 0 run scoreboard players operation @s ca.attr_random_crit += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomAttributes[{id:"luck"}].amount 10
execute unless score $temp ca.susu matches 0 run scoreboard players operation @s ca.attr_luck += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomAttributes[{id:"aoe_size"}].amount 100
