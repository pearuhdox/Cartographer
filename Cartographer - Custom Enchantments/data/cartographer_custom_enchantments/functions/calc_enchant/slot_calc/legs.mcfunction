...
execute store result score $temp ca.susu run data get storage ca.susu:enchants legs.tag.CustomEnchantments[{id:"fire_cleansing"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants legs.tag.CustomEnchantments[{id:"lifeblood"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants legs.tag.CustomEnchantments[{id:"starfall"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants legs.tag.CustomEnchantments[{id:"deadeye"}].lvl
...
execute if score $temp ca.susu matches 1.. run tag @s add ca.ce_deadeye_legs
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants legs.tag.CustomEnchantments[{id:"poise"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants legs.tag.CustomEnchantments[{id:"curse_misfortune"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants legs.tag.CustomAttributes[{id:"ranged_flat"}].amount 10
...
scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants legs.tag.CustomAttributes[{id:"luck"}].amount 10
execute unless score $temp ca.susu matches 0 run scoreboard players operation @s ca.attr_luck += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants legs.tag.CustomAttributes[{id:"random_crit"}].amount 100
execute unless score $temp ca.susu matches 0 run scoreboard players operation @s ca.attr_random_crit += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants legs.tag.CustomAttributes[{id:"aoe_size"}].amount 100
