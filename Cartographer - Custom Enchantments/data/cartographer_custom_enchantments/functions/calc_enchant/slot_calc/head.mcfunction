...
execute store result score $temp ca.susu run data get storage ca.susu:enchants head.tag.CustomEnchantments[{id:"fire_cleansing"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants head.tag.CustomEnchantments[{id:"lifeblood"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants head.tag.CustomEnchantments[{id:"curse_misfortune"}].lvl
