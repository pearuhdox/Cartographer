...
execute store result score $temp ca.susu run data get storage ca.susu:enchants head.tag.CustomEnchantments[{id:"steadfast"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants head.tag.CustomEnchantments[{id:"deadeye"}].lvl
...
execute if score $temp ca.susu matches 1.. run tag @s add ca.ce_deadeye_head
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants head.tag.CustomEnchantments[{id:"curse_fizzling"}].lvl
...
scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants head.tag.CustomAttributes[{id:"ranged_speed"}].amount 100
execute unless score $temp ca.susu matches 0 run scoreboard players operation @s ca.attr_ranged_speed += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants head.tag.CustomAttributes[{id:"potion_size"}].amount 10
execute unless score $temp ca.susu matches 0 run scoreboard players operation @s ca.attr_potion_size += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants head.tag.CustomAttributes[{id:"luck"}].amount 10
execute unless score $temp ca.susu matches 0 run scoreboard players operation @s ca.attr_luck += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants head.tag.CustomAttributes[{id:"random_crit"}].amount 100
execute unless score $temp ca.susu matches 0 run scoreboard players operation @s ca.attr_random_crit += $temp ca.susu

scoreboard players set $temp ca.susu 0
execute store result score $temp ca.susu run data get storage ca.susu:enchants head.tag.CustomAttributes[{id:"aoe_size"}].amount 100
