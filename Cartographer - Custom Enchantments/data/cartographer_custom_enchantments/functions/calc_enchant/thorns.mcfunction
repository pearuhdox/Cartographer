...
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.feet.tag.CustomEnchantments[{id:"first_strike"}].lvl
scoreboard players operation @s ca.t_first += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.feet.tag.CustomEnchantments[{id:"cauterize"}].lvl
scoreboard players operation @s ca.t_cau += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.feet.tag.CustomEnchantments[{id:"hex_eater"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.feet.tag.CustomEnchantments[{id:"tempo_theft"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.legs.tag.CustomEnchantments[{id:"first_strike"}].lvl
scoreboard players operation @s ca.t_first += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.legs.tag.CustomEnchantments[{id:"cauterize"}].lvl
scoreboard players operation @s ca.t_cau += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.legs.tag.CustomEnchantments[{id:"hex_eater"}].lvl
scoreboard players operation @s ca.t_hex += $temp ca.susu
...
scoreboard players operation @s ca.t_exec += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.legs.tag.CustomEnchantments[{id:"tempo_theft"}].lvl
scoreboard players operation @s ca.t_tempo += $temp ca.susu
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.body.tag.CustomEnchantments[{id:"first_strike"}].lvl
scoreboard players operation @s ca.t_first += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.body.tag.CustomEnchantments[{id:"cauterize"}].lvl
scoreboard players operation @s ca.t_cau += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.body.tag.CustomEnchantments[{id:"hex_eater"}].lvl
scoreboard players operation @s ca.t_hex += $temp ca.susu
...
scoreboard players operation @s ca.t_exec += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.body.tag.CustomEnchantments[{id:"tempo_theft"}].lvl
scoreboard players operation @s ca.t_tempo += $temp ca.susu
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.head.tag.CustomEnchantments[{id:"first_strike"}].lvl
scoreboard players operation @s ca.t_first += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.head.tag.CustomEnchantments[{id:"cauterize"}].lvl
scoreboard players operation @s ca.t_cau += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.head.tag.CustomEnchantments[{id:"hex_eater"}].lvl
scoreboard players operation @s ca.t_hex += $temp ca.susu
...
scoreboard players operation @s ca.t_exec += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.head.tag.CustomEnchantments[{id:"tempo_theft"}].lvl
scoreboard players operation @s ca.t_tempo += $temp ca.susu
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.offh.tag.CustomEnchantments[{id:"first_strike"}].lvl
scoreboard players operation @s ca.t_first += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.offh.tag.CustomEnchantments[{id:"cauterize"}].lvl
scoreboard players operation @s ca.t_cau += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.offh.tag.CustomEnchantments[{id:"hex_eater"}].lvl
scoreboard players operation @s ca.t_hex += $temp ca.susu
...
scoreboard players operation @s ca.t_exec += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.offh.tag.CustomEnchantments[{id:"tempo_theft"}].lvl
scoreboard players operation @s ca.t_tempo += $temp ca.susu
