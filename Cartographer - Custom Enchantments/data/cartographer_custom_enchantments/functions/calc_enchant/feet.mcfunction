...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"cauterize"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"lightborn"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"confidence"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants feet.tag.CustomEnchantments[{id:"desperation"}].lvl
