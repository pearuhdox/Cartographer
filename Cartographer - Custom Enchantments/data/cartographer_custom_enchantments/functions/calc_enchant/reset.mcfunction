scoreboard players set @s ca.adrenaline 0
scoreboard players set @s ca.agility 0
scoreboard players set @s ca.aquadynamic 0
scoreboard players set @s ca.auto_charge 0
scoreboard players set @s ca.s_cleansing 0
scoreboard players set @s ca.f_cleansing 0
...
scoreboard players set @s ca.executioner 0
...
scoreboard players set @s ca.second_wind 0
scoreboard players set @s ca.sharpshot 0
scoreboard players set @s ca.singe 0
...
scoreboard players set @s ca.flame 0
scoreboard players set @s ca.power 0
...
tag @s remove ca.reconstruct_1
tag @s remove ca.reconstruct_2
tag @s remove ca.reconstruct_3
tag @s remove ca.reconstruct_4
tag @s remove ca.reconstruct_5
tag @s remove ca.reconstruct_6
tag @s remove ca.reconstruct_7
tag @s remove ca.reconstruct_8
tag @s remove ca.reconstruct_9

tag @s remove ca.reconstruct_feet
tag @s remove ca.reconstruct_legs
tag @s remove ca.reconstruct_body
tag @s remove ca.reconstruct_head

tag @s remove ca.reconstruct_offh
