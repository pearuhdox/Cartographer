...
execute store result score $temp ca.susu run data get storage ca.susu:enchants gravity_items.body.tag.CustomEnchantments[{id:"duelist"}].lvl
scoreboard players operation @s ca.g_duelist += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants gravity_items.body.tag.CustomEnchantments[{id:"hunter"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants gravity_items.body.tag.Enchantments[{id:"minecraft:smite"}].lvl
