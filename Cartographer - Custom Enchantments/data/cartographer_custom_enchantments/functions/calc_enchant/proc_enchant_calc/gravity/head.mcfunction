execute store result score $temp ca.susu run data get storage ca.susu:enchants gravity_items.head.tag.CustomEnchantments[{id:"first_strike"}].lvl
scoreboard players operation @s ca.g_first += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants gravity_items.head.tag.CustomEnchantments[{id:"cauterize"}].lvl
scoreboard players operation @s ca.g_cau += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants gravity_items.head.tag.CustomEnchantments[{id:"hex_eater"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants gravity_items.head.tag.CustomEnchantments[{id:"tempo_theft"}].lvl
scoreboard players operation @s ca.g_tempo += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants gravity_items.head.tag.CustomEnchantments[{id:"duelist"}].lvl
scoreboard players operation @s ca.g_duelist += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants gravity_items.head.tag.CustomEnchantments[{id:"hunter"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants gravity_items.head.tag.Enchantments[{id:"minecraft:smite"}].lvl
