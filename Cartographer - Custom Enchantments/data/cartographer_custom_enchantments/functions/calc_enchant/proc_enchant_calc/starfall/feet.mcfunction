...
execute store result score $temp ca.susu run data get storage ca.susu:enchants starfall_items.feet.tag.CustomEnchantments[{id:"duelist"}].lvl
scoreboard players operation @s ca.sm_duelist += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants starfall_items.feet.tag.CustomEnchantments[{id:"hunter"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants starfall_items.feet.tag.Enchantments[{id:"minecraft:smite"}].lvl
