...
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.legs.tag.CustomEnchantments[{id:"duelist"}].lvl
scoreboard players operation @s ca.t_duelist += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants thorns_items.legs.tag.CustomEnchantments[{id:"hunter"}].lvl
