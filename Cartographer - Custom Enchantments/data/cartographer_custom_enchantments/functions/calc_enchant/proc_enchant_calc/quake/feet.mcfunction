...
execute store result score $temp ca.susu run data get storage ca.susu:enchants quake_items.feet.tag.CustomEnchantments[{id:"duelist"}].lvl
scoreboard players operation @s ca.qu_duelist += $temp ca.susu
execute store result score $temp ca.susu run data get storage ca.susu:enchants quake_items.feet.tag.CustomEnchantments[{id:"hunter"}].lvl
...
execute store result score $temp ca.susu run data get storage ca.susu:enchants quake_items.feet.tag.Enchantments[{id:"minecraft:smite"}].lvl
