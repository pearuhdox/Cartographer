...
execute if score @s ca.sw_tier matches 3600.. run scoreboard players set @s ca.damage_queue 6
...
execute if score @s ca.sw_tier matches 3600.. run function bb:call/hpm/player/damage/true

execute if score @s ca.sw_tier matches 7200.. run scoreboard players set @s ca.damage_queue 12
...
execute if score @s ca.sw_tier matches 7200.. run function bb:call/hpm/player/damage/true

execute if score @s ca.sw_tier matches 10800.. run scoreboard players set @s ca.damage_queue 18
...
execute if score @s ca.sw_tier matches 10800.. run function bb:call/hpm/player/damage/true
