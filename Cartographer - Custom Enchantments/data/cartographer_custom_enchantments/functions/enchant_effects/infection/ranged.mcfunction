...
tag @s[type=#cartographer_core:hostile,tag=is_infection_1] remove is_infection_1
tag @s[type=#cartographer_core:hostile,tag=is_infection_2] remove is_infection_2
tag @s[type=#cartographer_core:hostile,tag=is_infection_3] remove is_infection_3
