...
tag @s[type=#cartographer_core:hostile,tag=is_exposing_1] remove is_exposing_1
tag @s[type=#cartographer_core:hostile,tag=is_exposing_2] remove is_exposing_2
tag @s[type=#cartographer_core:hostile,tag=is_exposing_3] remove is_exposing_3
