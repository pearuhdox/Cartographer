...
execute if score @s duelist matches 1.. run execute as @e[type=#cartographer_core:humanoid,distance=..5,nbt=!{HurtTime:0s}] at @s run function cartographer_custom_enchantments:enchant_effects/duelist/branch
