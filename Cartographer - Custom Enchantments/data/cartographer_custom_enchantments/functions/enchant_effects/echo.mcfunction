execute if entity @s[scores={echo=1..,echo_charges=1..}] positioned ^ ^1 ^3 run particle minecraft:cloud ~ ~1 ~ 0 0 0 0.15 5 normal
execute if entity @s[scores={echo=1..,echo_charges=1..}] positioned ^ ^1 ^3 run particle minecraft:enchant ~ ~1 ~ 0.2 0.2 0.2 0.5 20 normal
