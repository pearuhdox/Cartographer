...
execute if entity @s[scores={ca.kill_entity=0,ca.echo=1,ca.echo_charges=..1}] run scoreboard players add @s ca.echo_charges 1
execute if entity @s[scores={ca.kill_entity=0,ca.echo=2,ca.echo_charges=..2}] run scoreboard players add @s ca.echo_charges 1
execute if entity @s[scores={ca.kill_entity=0,ca.echo=3,ca.echo_charges=..3}] run scoreboard players add @s ca.echo_charges 1
