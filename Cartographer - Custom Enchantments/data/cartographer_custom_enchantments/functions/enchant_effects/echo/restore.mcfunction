...
execute if entity @s[scores={ca.kill_entity=0,ca.echo=5,ca.echo_charges=..3}] run scoreboard players add @s ca.echo_charges 1
...
execute if entity @s[scores={ca.echo=5,ca.echo_charges=6..}] run scoreboard players set @s ca.echo_charges 5
