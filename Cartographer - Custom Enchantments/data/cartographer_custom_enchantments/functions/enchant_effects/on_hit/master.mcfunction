...
execute if score $punch ca.weapon_var matches 1.. unless score $knockback ca.weapon_var matches 1.. run function cartographer_custom_enchantments:enchant_effects/knockback/punch
