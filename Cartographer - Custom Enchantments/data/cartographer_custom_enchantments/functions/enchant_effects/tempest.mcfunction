...
tag @s[type=#cartographer_core:hostile,tag=is_tempest_3] remove is_tempest_3
tag @s[type=#cartographer_core:hostile,tag=is_tempest_4] remove is_tempest_4
tag @s[type=#cartographer_core:hostile,tag=is_tempest_5] remove is_tempest_5
