execute if entity @s[scores={transfiguration=1..}] run function cartographer_core:helper/randomize

execute if entity @s[scores={transfiguration=1..}] run scoreboard players operation @s helper_melee = @s random
