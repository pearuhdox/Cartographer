...
execute unless score @s ca.trans_cdl matches 1.. as @e[type=#cartographer_core:hostile,tag=!elite,tag=!boss,distance=..5,nbt=!{HurtTime:0s}] at @s run function cartographer_custom_enchantments:enchant_effects/transfiguration/branch
