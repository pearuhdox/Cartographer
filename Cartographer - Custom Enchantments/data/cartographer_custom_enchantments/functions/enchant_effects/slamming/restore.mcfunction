...
execute if entity @s[scores={ca.kill_entity=0,ca.slamming=5,ca.sweeping_charges=..4}] run scoreboard players add @s ca.slamming_charges 1
...
execute if entity @s[scores={ca.slamming=5,ca.slamming_charges=6..}] run scoreboard players set @s ca.slamming_charges 5
