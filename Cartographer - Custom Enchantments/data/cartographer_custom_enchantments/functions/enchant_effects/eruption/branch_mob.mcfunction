...
execute unless score $eruption knockback matches 1.. run function cartographer_core:helper/push_half
...
execute if score $eruption knockback matches 1 run function cartographer_core:helper/push
execute if score $eruption knockback matches 2 run function cartographer_core:helper/push_2
execute if score $eruption knockback matches 3 run function cartographer_core:helper/push_3
execute if score $eruption knockback matches 4 run function cartographer_core:helper/push_4
execute if score $eruption knockback matches 5 run function cartographer_core:helper/push_5
...
execute if score $eruption frostbite matches 1.. run particle minecraft:item_snowball ~ ~1 ~ 0.3 0.5 0.3 0.5 15 normal
...
execute if score $eruption decay matches 1.. run particle minecraft:dust 0.1 0 0 0.25 ~ ~1 ~ 0.3 0.5 0.3 0.5 15 normal
...
execute if score $eruption overload matches 1.. run particle minecraft:firework ~ ~1 ~ 0.5 0.5 0.5 0.2 10 normal
...
execute if score $eruption vicious matches 1.. run particle minecraft:block minecraft:redstone_block ~ ~1 ~ 0.25 0.4 0.25 0 10 normal
...
execute if score $eruption stunning matches 1 run particle minecraft:firework ~ ~1 ~ 0.3 0.5 0.3 0.05 10 normal
execute if score $eruption stunning matches 2 run particle minecraft:firework ~ ~1 ~ 0.3 0.5 0.3 0.05 10 normal
execute if score $eruption stunning matches 3 run particle minecraft:firework ~ ~1 ~ 0.3 0.5 0.3 0.05 10 normal
execute if score $eruption stunning matches 4 run particle minecraft:firework ~ ~1 ~ 0.3 0.5 0.3 0.05 10 normal
execute if score $eruption stunning matches 5 run particle minecraft:firework ~ ~1 ~ 0.3 0.5 0.3 0.05 10 normal

execute if score $eruption stunning matches 1 run playsound minecraft:entity.firework_rocket.twinkle player @a[distance=..8] ~ ~ ~ 0.5 1.25
execute if score $eruption stunning matches 2 run playsound minecraft:entity.firework_rocket.twinkle player @a[distance=..8] ~ ~ ~ 0.5 1.25
execute if score $eruption stunning matches 3 run playsound minecraft:entity.firework_rocket.twinkle player @a[distance=..8] ~ ~ ~ 0.5 1.25
execute if score $eruption stunning matches 4 run playsound minecraft:entity.firework_rocket.twinkle player @a[distance=..8] ~ ~ ~ 0.5 1.25
execute if score $eruption stunning matches 5 run playsound minecraft:entity.firework_rocket.twinkle player @a[distance=..8] ~ ~ ~ 0.5 1.25
