...
execute if data storage cartographer_custom_enchantments:shattering {temp_item:"minecraft:trident"} run scoreboard players set @s ca.max_dmg 250
execute if data storage cartographer_custom_enchantments:shattering {temp_item:"minecraft:bow"} run scoreboard players set @s ca.max_dmg 384
execute if data storage cartographer_custom_enchantments:shattering {temp_item:"minecraft:crossbow"} run scoreboard players set @s ca.max_dmg 465

execute if data storage cartographer_custom_enchantments:shattering {temp_item:"minecraft:flint_and_steel"} run scoreboard players set @s ca.max_dmg 64
execute if data storage cartographer_custom_enchantments:shattering {temp_item:"minecraft:brush"} run scoreboard players set @s ca.max_dmg 64
