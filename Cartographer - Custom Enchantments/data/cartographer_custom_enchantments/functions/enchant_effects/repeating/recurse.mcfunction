...
clear @s[gamemode=!creative,tag=loading_normal,scores={ca.ammo=2..}] arrow 1
clear @s[gamemode=!creative,tag=loading_spectral,scores={ca.ammo=2..}] spectral_arrow 1
clear @s[gamemode=!creative,tag=loading_tipped,scores={ca.ammo=2..}] tipped_arrow 1
