...
execute if score $ranged_damage ca.var matches 1.. run scoreboard players operation $damage ca.explosive = $ranged_damage ca.var
execute if score $ranged_damage ca.var matches 1.. run scoreboard players operation $damage ca.explosive /= $10 ca.CONSTANT
execute if score $ranged_damage ca.var matches 1.. run scoreboard players operation $damage ca.explosive /= $2 ca.CONSTANT

execute unless score $ranged_damage ca.var matches 1.. run scoreboard players operation $damage ca.explosive /= $2 ca.CONSTANT
execute unless score $ranged_damage ca.var matches 1.. run scoreboard players operation $damage ca.explosive *= $50 ca.CONSTANT
execute unless score $ranged_damage ca.var matches 1.. run scoreboard players operation $damage ca.explosive /= $100 ca.CONSTANT
...
execute as @e[type=#bb:hostile,distance=0.1..4.5] at @s run function cartographer_custom_enchantments:enchant_effects/explosive/branch
