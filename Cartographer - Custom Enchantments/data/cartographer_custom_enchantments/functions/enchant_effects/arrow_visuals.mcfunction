...
execute if score @s ca.explosive matches 1.. if score @s ca.point_blank matches 1.. run scoreboard players remove @s ca.vol_dmg 1
execute if score @s ca.explosive matches 1.. if score @s ca.point_blank matches 2.. run scoreboard players remove @s ca.vol_dmg 1
execute if score @s ca.explosive matches 1.. if score @s ca.point_blank matches 3.. run scoreboard players remove @s ca.vol_dmg 1
