...
execute if entity @s[scores={ca.kill_entity=0,ca.thrusting=5,ca.thrusting_charges=..4}] run scoreboard players add @s ca.thrusting_charges 1
...
execute if entity @s[scores={ca.thrusting=5,ca.thrusting_charges=6..}] run scoreboard players set @s ca.thrusting_charges 5
