scoreboard players operation $negative ca.curse_fizzling_main = @s ca.curse_fizzling_main
scoreboard players operation $negative ca.curse_fizzling_main *= $5 ca.CONSTANT

scoreboard players set $target ca.rand_var 100
scoreboard players operation $target ca.rand_var -= $negative ca.curse_fizzling_main
