...
execute if entity @s[scores={ca.electrocute=1..}] as @e[type=#cartographer_core:hostile,distance=..5,nbt=!{HurtTime:0s}] at @s run function cartographer_custom_enchantments:enchant_effects/electrocute/branch
