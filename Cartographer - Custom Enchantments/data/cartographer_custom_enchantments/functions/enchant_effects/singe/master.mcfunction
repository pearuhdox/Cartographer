...
execute if score @s ca.singe matches 1.. as @e[type=!#bb:fiery,distance=..5,nbt=!{HurtTime:0s},nbt=!{Fire:-1s}] at @s if entity @s[type=#bb:hostile] run function cartographer_custom_enchantments:enchant_effects/singe/branch