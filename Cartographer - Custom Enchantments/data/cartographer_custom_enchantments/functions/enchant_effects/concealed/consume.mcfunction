...
execute if entity @s[scores={ca.conceal_time=80..}] run execute as @e[type=#cartographer_core:hostile,distance=..6,nbt=!{HurtTime:0s},limit=1,sort=nearest] at @s run particle minecraft:campfire_cosy_smoke ~ ~1 ~ 0 0 0 0.05 15 normal
