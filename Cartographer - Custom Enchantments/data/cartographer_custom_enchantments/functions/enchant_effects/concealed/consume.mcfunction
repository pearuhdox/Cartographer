...
execute if entity @s[scores={ca.conceal_time=80..,ca.deal_mel_dmg=1..}] run playsound minecraft:entity.player.attack.sweep player @a[distance=..12] ~ ~ ~ 4 1.5
execute if entity @s[scores={ca.conceal_time=80..,ca.deal_mel_dmg=1..}] run playsound minecraft:block.anvil.land player @a[distance=..12] ~ ~ ~ 1 2
