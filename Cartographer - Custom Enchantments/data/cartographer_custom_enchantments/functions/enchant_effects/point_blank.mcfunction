scoreboard players operation $ranged point_blank = @s point_blank

execute as @e[type=arrow,sort=nearest,limit=3,distance=..5] at @s run function cartographer_custom_enchantments:enchant_effects/point_blank_branch
