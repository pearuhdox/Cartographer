execute if entity @s[scores={concealed=1..}] run execute unless entity @e[type=#cartographer_core:hostile,distance=..12] run scoreboard players add @s[scores={ca.conceal_time=..78}] ca.conceal_time 1
