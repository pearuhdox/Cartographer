...
scoreboard players operation $threshold ca.exec_low = $lvl ca.executioner
...
execute if score @s ca.exec_low <= $threshold ca.exec_low at @s run function cartographer_custom_enchantments:enchant_effects/executioner/kill_branch