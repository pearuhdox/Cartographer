...
execute if entity @s[tag=ca.gravity_falling] run scoreboard players add @s ca.gravity_time 1
...
execute unless entity @s[tag=ca.gravity_falling] run scoreboard players set @s ca.gravity_time 0