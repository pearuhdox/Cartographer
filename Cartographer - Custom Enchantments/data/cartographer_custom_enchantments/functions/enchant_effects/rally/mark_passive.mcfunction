...
execute if score @s ca.rally_mark_dur matches 90 run function cartographer_custom_enchantments:enchant_effects/rally/mark_passive/chime
execute if score @s ca.rally_mark_dur matches 75 run function cartographer_custom_enchantments:enchant_effects/rally/mark_passive/chime
