...
execute anchored eyes positioned ^ ^ ^1 as @e[type=arrow,tag=ca.multishot_spawn,sort=nearest,limit=2,distance=..5] run function cartographer_custom_enchantments:enchant_effects/multishot/modify_arrow 