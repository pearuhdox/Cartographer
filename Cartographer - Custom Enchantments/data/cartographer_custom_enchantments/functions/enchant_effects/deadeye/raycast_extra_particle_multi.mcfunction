...
execute if entity @s[tag=bleed] run particle minecraft:dust 0.478 0.039 0.039 1 ~ ~ ~ 0.1 0.1 0.1 0.5 1 normal
execute if entity @s[tag=electrode] run particle minecraft:dust 0.827 0.969 0.969 1 ~ ~ ~ 0.1 0.1 0.1 0.5 1 normal
...
execute if entity @s[tag=infect] run particle minecraft:dust 0 0 0 1 ~ ~ ~ 0.1 0.1 0.1 0.5 1 normal
