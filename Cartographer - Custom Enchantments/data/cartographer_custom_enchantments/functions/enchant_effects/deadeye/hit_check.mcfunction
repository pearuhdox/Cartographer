...
data modify storage cartographer_custom_statuses:apply_effects data.Effects set from entity @s data.ApplyEffects
data modify storage cartographer_custom_statuses:status_inflict data.Effects set from entity @s data.StatusInflict
