...
execute if score $deadeye ca.trueshot matches 1.. run tp @s ~ ~ ~ facing entity @e[limit=1,type=#cartographer_core:hostile,distance=..26,sort=random,nbt={HurtTime:0s}] feet
execute if score $deadeye ca.curse_encum matches 1.. run tp @s ~ ~ ~ facing entity @e[limit=1,type=#cartographer_core:hostile,distance=..8,sort=random,nbt={HurtTime:0s}] feet
execute unless score $deadeye ca.trueshot matches 1.. unless score $deadeye ca.trueshot matches 1.. run tp @s ~ ~ ~ facing entity @e[limit=1,type=#cartographer_core:hostile,distance=..13,sort=random,nbt={HurtTime:0s}] feet
