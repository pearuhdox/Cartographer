...
execute if score $temp ca.var matches 1.. at @s as @e[type=#bb:arrow,distance=..7,nbt=!{inGround:1b}] run function cartographer_custom_enchantments:enchant_effects/branch/check_player_branch