scoreboard players operation $bleed ca.var = @s ca.bleed

scoreboard players operation $electrode ca.var = @s ca.electrode

scoreboard players operation $expose ca.var = @s ca.expose

scoreboard players operation $frost ca.var = @s ca.frost

scoreboard players operation $infect ca.var = @s ca.infect

scoreboard players operation $possess ca.var = @s ca.possess

scoreboard players operation $flash ca.var = @s ca.flash
