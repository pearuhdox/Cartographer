...
#Frostbite
scoreboard players operation $fb ca.frostbite = $frostbite ca.quake
execute if score $frostbite ca.quake matches 1.. at @s run function cartographer_custom_enchantments:enchant_effects/frostbite/branch
