...
scoreboard players operation $eruption ca.committed = @s ca.committed
scoreboard players operation $eruption ca.decay = @s ca.decay
scoreboard players operation $eruption ca.vicious = @s ca.vicious
scoreboard players operation $eruption ca.overload = @s ca.overload
...
scoreboard players set $eruption ca.committed 0
scoreboard players set $eruption ca.decay 0
scoreboard players set $eruption ca.vicious 0
scoreboard players set $eruption ca.overload 0
