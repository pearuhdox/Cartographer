execute if entity @s[scores={ca.fire_aspect=1}] as @e[type=#cartographer_core:hostile,distance=..1] at @s run data modify entity @s Fire set value 81
execute if entity @s[scores={ca.fire_aspect=2}] as @e[type=#cartographer_core:hostile,distance=..1] at @s run data modify entity @s Fire set value 161
execute if entity @s[scores={ca.fire_aspect=3..}] as @e[type=#cartographer_core:hostile,distance=..1] at @s run data modify entity @s Fire set value 241

execute if entity @s[scores={ca.frostbite=1}] as @e[type=#cartographer_core:hostile,distance=..1] at @s run scoreboard players set @s ca.frost_tier 1
execute if entity @s[scores={ca.frostbite=2}] as @e[type=#cartographer_core:hostile,distance=..1] at @s run scoreboard players set @s ca.frost_tier 2
execute if entity @s[scores={ca.frostbite=3}] as @e[type=#cartographer_core:hostile,distance=..1] at @s run scoreboard players set @s ca.frost_tier 3
execute if entity @s[scores={ca.frostbite=4}] as @e[type=#cartographer_core:hostile,distance=..1] at @s run scoreboard players set @s ca.frost_tier 4
...
execute if entity @s[scores={ca.stunning=1,ca.melee_chance=..10}] as @e[type=#cartographer_core:hostile,distance=..1,limit=1,sort=nearest] at @s run scoreboard players set @s ca.effect_stun 21
execute if entity @s[scores={ca.stunning=2,ca.melee_chance=..20}] as @e[type=#cartographer_core:hostile,distance=..1,limit=1,sort=nearest] at @s run scoreboard players set @s ca.effect_stun 21
execute if entity @s[scores={ca.stunning=3,ca.melee_chance=..30}] as @e[type=#cartographer_core:hostile,distance=..1,limit=1,sort=nearest] at @s run scoreboard players set @s ca.effect_stun 21
execute if entity @s[scores={ca.stunning=4,ca.melee_chance=..40}] as @e[type=#cartographer_core:hostile,distance=..1,limit=1,sort=nearest] at @s run scoreboard players set @s ca.effect_stun 21
execute if entity @s[scores={ca.stunning=5..,ca.melee_chance=..50}] as @e[type=#cartographer_core:hostile,distance=..1,limit=1,sort=nearest] at @s run scoreboard players set @s ca.effect_stun 21