...
execute if entity @s[scores={ca.kill_entity=0,ca.evocation=5,ca.evocation_charges=..3}] run scoreboard players add @s ca.evocation_charges 1
...
execute if entity @s[scores={ca.evocation=5,ca.evocation_charges=6..}] run scoreboard players set @s ca.evocation_charges 5
