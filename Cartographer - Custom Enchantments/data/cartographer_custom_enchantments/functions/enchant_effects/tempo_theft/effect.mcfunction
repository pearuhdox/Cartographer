...
attribute @s[scores={ca.temp_warp=600},type=#cartographer_core:hostile] minecraft:generic.movement_speed modifier add 31-20-5-13-16 "temp_warp-3" -0.45 multiply
...
attribute @s[scores={ca.temp_warp=400},type=#cartographer_core:hostile] minecraft:generic.movement_speed modifier add 31-20-5-13-16 "temp_warp-2" -0.3 multiply
...
attribute @s[scores={ca.temp_warp=200},type=#cartographer_core:hostile] minecraft:generic.movement_speed modifier add 31-20-5-13-16 "temp_warp-1" -0.15 multiply
