...
tag @s[type=#cartographer_core:hostile,tag=is_fire_aspect_1] remove is_fire_aspect_1
tag @s[type=#cartographer_core:hostile,tag=is_fire_aspect_2] remove is_fire_aspect_2
tag @s[type=#cartographer_core:hostile,tag=is_fire_aspect_3] remove is_fire_aspect_3
