...
execute as @s[scores={curse_two_handed=1}] if entity @s[nbt={Inventory:[{Slot:-106b}]}] at @s run function cartographer_custom_enchantments:enchant_effects/curse_two_handed/disable_offhand
