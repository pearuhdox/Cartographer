...
execute if score $melee ca.first_strike matches 1 if score $critting ca.first_strike matches 1 run scoreboard players set @s cdl.damage_queue 6
execute if score $melee ca.first_strike matches 2 if score $critting ca.first_strike matches 1 run scoreboard players set @s cdl.damage_queue 12
execute if score $melee ca.first_strike matches 3.. if score $critting ca.first_strike matches 1 run scoreboard players set @s cdl.damage_queue 18
