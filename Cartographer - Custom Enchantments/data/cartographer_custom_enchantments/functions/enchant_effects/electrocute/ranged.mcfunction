...
tag @s[type=#cartographer_core:hostile,tag=is_electrocute_1] remove is_electrocute_1
tag @s[type=#cartographer_core:hostile,tag=is_electrocute_2] remove is_electrocute_2
tag @s[type=#cartographer_core:hostile,tag=is_electrocute_3] remove is_electrocute_3
