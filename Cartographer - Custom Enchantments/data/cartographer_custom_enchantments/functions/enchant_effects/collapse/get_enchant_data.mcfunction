...
execute store result score $infection ca.collapse run data get entity @s Trident.tag.CustomEnchantments[{id:"infection"}].lvl
execute store result score $bleeding ca.collapse run data get entity @s Trident.tag.CustomEnchantments[{id:"bleeding"}].lvl
execute store result score $electrocute ca.collapse run data get entity @s Trident.tag.CustomEnchantments[{id:"electrocute"}].lvl
execute store result score $stunning ca.collapse run data get entity @s Trident.tag.CustomEnchantments[{id:"stunning"}].lvl
