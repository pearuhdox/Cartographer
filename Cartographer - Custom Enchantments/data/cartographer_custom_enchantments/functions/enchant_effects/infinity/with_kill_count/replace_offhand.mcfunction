data modify storage cartographer_custom_enchantments:infinity transformed set value {id:"minecraft:firework_star",Count:1b,tag:{StoredItem:{},display:{Name:'{"text":"Infinite Potential","color":"#EAB0FF","italic":false}',Lore:['{"text":"This Infinity item has a cooldown.","color":"gray","italic":false}','{"text":"It is currently recharging and","color":"gray","italic":false}','{"text":"can be used again when recharged.","color":"gray","italic":false}','{"text":" "}','{"text":"The item is rechared by getting kills","color":"gray","italic":false}','{"text":"while the item is on your hotbar or offhand.","color":"gray","italic":false}']},HideFlags:32,Explosion:{Type:0,Colors:[I;9866889]}}}
...
execute store result score @s ca.inf_kc_o run data get storage cartographer_custom_enchantments:infinity transformed.tag.StoredItem.tag.InfinityKillCount
scoreboard players add @s ca.inf_kc_o 1
