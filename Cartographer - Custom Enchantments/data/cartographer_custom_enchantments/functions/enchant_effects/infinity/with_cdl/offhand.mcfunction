...
execute if data storage cartographer_custom_enchantments:infinity cdl_item[0].tag.InfinityKillCount run function cartographer_custom_enchantments:enchant_effects/infinity/with_kill_count/replace_offhand