...
execute if score @s ca.use_egg matches 1.. run function cartographer_custom_enchantments:enchant_effects/infinity/check_edgecases
execute if score @s ca.use_snowball matches 1.. run function cartographer_custom_enchantments:enchant_effects/infinity/check_edgecases
