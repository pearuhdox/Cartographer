...
tag @e[type=#cartographer_core:hostile,tag=is_bleeding_1,distance=..12] remove is_bleeding_1
tag @e[type=#cartographer_core:hostile,tag=is_bleeding_2,distance=..12] remove is_bleeding_2
tag @e[type=#cartographer_core:hostile,tag=is_bleeding_3,distance=..12] remove is_bleeding_3
