...
execute if score @s hunter matches 1.. as @e[type=#cartographer_core:monstrous,distance=..5,nbt=!{HurtTime:0s}] at @s run function cartographer_custom_enchantments:enchant_effects/hunter/branch
