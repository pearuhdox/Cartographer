...
execute positioned ^ ^1 ^3 run function cartographer_custom_enchantments:enchant_effects/hydraulic_circle_raycast

execute positioned ^ ^ ^3 run execute as @e[type=#cartographer_core:hostile,distance=..3] at @s run function cartographer_custom_enchantments:enchant_effects/hydraulic_enemy_branch