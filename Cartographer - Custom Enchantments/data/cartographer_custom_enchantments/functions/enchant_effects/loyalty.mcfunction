...
execute anchored eyes positioned ^ ^ ^3 as @e[type=trident,distance=..5,tag=!loyalty_checked] at @s run function cartographer_custom_enchantments:enchant_effects/loyalty/save_trident
